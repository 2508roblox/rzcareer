...
function slugify(e) { return e = (e = (e = (e = (e = (e = (e = e.toLowerCase()).replace(/\//g, "-").normalize("NFD").replace(/[\u0300-\u036f]/g, "")).replace(/[đĐ]/g, "d")).replace(/([^0-9a-z-\s])/g, "")).replace(/(\s+)/g, "-")).replace(/-+/g, "-")).replace(/^-+|-+$/g, "") }! function() {
    "use strict";
    window.addEventListener("scroll", e => {
        let t = document.querySelector(".teks-shadow");
        window.pageYOffset > 0 ? t.classList.add("shadow") : t.classList.remove("shadow")
    });
    let e = new IntersectionObserver((e, t) => { e.forEach(e => { e.isIntersecting && (e.target.src = e.target.dataset.src, t.unobserve(e.target)) }) }, { threshold: .7 });
    setTimeout(function() { document.querySelectorAll(".lazy").forEach(t => { e.observe(t) }) }, 500)
}(), $(function() {
    $('#keyword').keypress(function(e) { if (e.which == 13) { $('#search').trigger('click'); return false; } });
    $(".btn-get-link").click(function() {
        var e = $(".input-get-link .phone");
        if (e.val() == '') { e.focus(); return; }
        $.ajax({
            url: "/ajax/request-sms",
            type: "post",
            data: { phone_number: e.val() },
            success: function(t) {
                var a = JSON.parse(t);
                let l = new bootstrap.Toast("#toast");
                1 == a.status ? ($(".toast-body").html(a.msg), e.val(""), l.show()) : ($(".toast-body").html(a.msg), l.show())
            },
            error: function(e, t, a) { console.log(t, a) }
        })
    }), $(window).width() > 1e3 && ($("#location").attr("placeholder", "Tỉnh/th\xe0nh, quận..."), $("#keyword").attr("placeholder", "Việc, c\xf4ng ty, ng\xe0nh nghề...")), $(".select2").select2({ theme: "bootstrap-5" }), $("#search").click(function() {
        ...
        var e = $("#keyword"),
            t = $("#location");
        e.val() ? t.val() ? window.location.href = "/viec-lam-" + slugify(e.val()) + "-tai-" + slugify(t.val().split(",")[0]) + ".html" + (utmSource ? "?utm_source=" + utmSource + "&utm_medium=" + utmMed + "&utm_term=" + utmTerm + "&utm_campaign=" + utmCampaign : '') : window.location.href = "/viec-lam-" + slugify(e.val()) + ".html" + (utmSource ? "?utm_source=" + utmSource + "&utm_medium=" + utmMed + "&utm_term=" + utmTerm + "&utm_campaign=" + utmCampaign : '') : t.val() ? window.location.href = "/viec-lam-tai-" + slugify(t.val().split(",")[0]) + ".html" + (utmSource ? "?utm_source=" + utmSource + "&utm_medium=" + utmMed + "&utm_term=" + utmTerm + "&utm_campaign=" + utmCampaign : '') : window.location.href = "/viec-lam.html" + (utmSource ? "?utm_source=" + utmSource + "&utm_medium=" + utmMed + "&utm_term=" + utmTerm + "&utm_campaign=" + utmCampaign : '')
    }), $("#research").click(function() {
        var e = $("#role"),
            t = $("#place");
        e.val() ? t.val() ? window.location.href = "/muc-luong-" + slugify(e.val()) + "/" + slugify(t.val()) + ".html" : window.location.href = "/muc-luong-" + slugify(e.val()) + ".html" : e.select2("open")
    });
    var e = $("#location");
    e.autocomplete({ source: function(t, a) { $.getJSON("/ajax/search-place", { k: e.val() }, a) }, minLength: 0 }).focus(function() { $(this).autocomplete("search") });
    var t = $("#keyword");
    t.autocomplete({ source: function(e, a) { $.getJSON("/ajax/search-keyword", { k: t.val() }, a) }, minLength: 0 }).focus(function() { $(this).autocomplete("search") })
});
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).window = t.window || {}) }(this, (function(t) {
    ...
    var nt = { ScrollLock: U, Thumbs: Y, Html: G, Toolbar: it, Image: K, Hash: J },
        ...
        rt = function(t) {
            ...
            return s(i, [{ key: "option", value: function(t) { for (var e, n = this.getSlide(), o = n ? n[t] : void 0, a = arguments.length, s = new Array(a > 1 ? a - 1 : 0), r = 1; r < a; r++) s[r - 1] = arguments[r]; if (void 0 !== o) { var l; if ("function" == typeof o) o = (l = o).call.apply(l, [this, this].concat(s)); return o } return (e = p(c(i.prototype), "option", this)).call.apply(e, [this, t].concat(s)) } }, {
            ...
            }, { key: "onSettle", value: function() { this.option("autoFocus") && this.focus() } }, { key: "onFocus", value: function(t) { this.isTopmost() && this.focus(t) } }, {
                key: "onClick",
                value: function(t) {
                ...
                value: function(t) {
                    if (this.isTopmost()) {
                        ...
                        if (i && !t.ctrlKey && !t.altKey && !t.shiftKey) {
                            ...
                            if (!1 !== this.trigger("keydown", e, t)) { var s = i[e]; "function" == typeof this[s] && this[s]() }
                        }
                    }
                }
            }, {
            ...
            }, { key: "isClosing", value: function() { return ["closing", "customClosing", "destroy"].includes(this.state) } }, { key: "isTopmost", value: function() { return i.getInstance().id == this.id } }, {
                key: "close",
                value: function(t) {
                    var e = this;
                ...
                value: function(t) {
                    ...
                    if (!t.defaultPrevented && !(t.button && 0 !== t.button || t.ctrlKey || t.metaKey || t.shiftKey)) {
                        ...
                        Array.from(i.openers.keys()).reverse().some((function(e) { a = r || s; var i = !1; try { a instanceof Element && ("string" == typeof e || e instanceof String) && (i = a.matches(e) || (a = a.closest(e))) } catch (t) {} return !!i && (t.preventDefault(), o = e, !0) }));
                        var h = !1;
                        if (o) {
            ...
            }, { key: "getInstance", value: function(t) { return t ? at.get(t) : Array.from(at.values()).reverse().find((function(t) { return !t.isClosing() && t })) || null } }, {
                key: "close",
                value: function() {
                    var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
...
$(function() { if ($(window).width() < 587) { $('.nav-link.dropdown-toggle').click(function(e) { e.preventDefault() }) } });
...
function readMore() { $('.read-more').readmore({ moreLink: '<a href="#">Xem thêm</a>', lessLink: '<a href="#">Rút gọn</a>', }); }
$(function() { readMore() });
...
! function(e, i) { "function" == typeof define && define.amd ? define(["tooltipster"], function(e) { return i(e) }) : "object" == typeof exports ? module.exports = i(require("tooltipster")) : i(jQuery) }(this, function(e) {
    return e.tooltipster._plugin({
        name: "laa.scrollableTip",
        instance: {
            __init: function(i) {
                var t = this;
                t.__instance = i, t.__maxSize, t.__namespace = "tooltipster-scrollableTip-" + Math.round(1e6 * Math.random()), t.__instance._on("positionTest." + t.__namespace, function(e) { "document" == e.container && e.takeTest(!1) }), t.__instance._on("positionTested." + t.__namespace, function(i) {
                    var n = !1;
                    if (e.each(i.results, function(e, i) { return i.whole ? (n = !0, !1) : void 0 }), n) t.__maxSize = null;
                    else {
                        var o, s, a = [];
                        e.each(i.results, function(e, t) {
                            if (a[e] = { height: Math.min(i.helper.geo.available.window[t.side].height - t.distance.vertical, i.helper.geo.window.size.height), width: Math.min(i.helper.geo.available.window[t.side].width - t.distance.horizontal, i.helper.geo.window.size.width) }, t.size.width <= a[e].width) {
                                var n = Math.min(t.size.height, a[e].height),
                                    _ = Math.min(t.size.width, a[e].width),
                                    h = n * _;
                                (!o || h > o) && (o = h, s = e)
                            }
                        }), i.edit([i.results[s]]), t.__maxSize = a[s]
                    }
                }), t.__instance._on("position." + t.__namespace, function(i) {
                    var n = i.position;
                    e(i.tooltip).off("." + t.__namespace), t.__maxSize ? (n.size.height > t.__maxSize.height && "bottom" !== n.side && (n.coord.top = 0), n.size.width > t.__maxSize.width && "right" !== n.side && (n.coord.left = 0), n.size.height = Math.min(n.size.height, t.__maxSize.height), n.size.width = Math.min(n.size.width, t.__maxSize.width), i.edit(n), t.__instance.option("interactive") || e(i.tooltip).css("pointer-events", "auto").on("mouseenter." + t.__namespace, function(e) { t.__instance._trigger({ dismissable: !1, type: "dismissable" }) }).on("mouseleave." + t.__namespace, function(e) { t.__instance._trigger({ delay: t.__instance.option("delayTouch")[1], dismissable: !0, event: e, type: "dismissable" }) })) : t.__instance.option("interactive") || e(i.tooltip).css("pointer-events", "")
                })
            },
            __destroy: function() { this.__instance._off("." + this.__namespace) }
        }
    }), e
});
const loadScriptsTimer = setTimeout(loadScripts, 4200),
    userInteractionEvents = ["mouseover", "keydown", "touchstart", "touchmove", "wheel"];

function triggerScriptLoader() { loadScripts(), clearTimeout(loadScriptsTimer), userInteractionEvents.forEach(function(t) { window.removeEventListener(t, triggerScriptLoader, { passive: !0 }) }) }

function loadScripts() { document.querySelectorAll('script[data-type="lazy"]').forEach(function(t) { t.setAttribute("src", t.getAttribute("data-src")) }) }
userInteractionEvents.forEach(function(t) { window.addEventListener(t, triggerScriptLoader, { passive: !0 }) });
...
if ("function" != typeof ga) {
    function ga(e, n, t, a, f, o) { gtag("event", a, { event_category: t, event_label: f, value: o }) };
};