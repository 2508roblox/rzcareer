                            ...
                            <div class="content-group ">
                              <div class="panel-body bg-blue-800 text-center ">
                                <div class="content-group-sm ">
                                  <a data-caption="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng " data-fancybox data-type="iframe " class="text-white " href="https://jobsgo.vn/candidate/detail?v=1727566911 " title="Hồ sơ xin việc của bạn trong mắt nhà tuyển
                                                dụng ">
                                            ...
                                            <div class="col-sm-9 ">
                                                ...
                                                <label class="checkbox ">
                                                    <input type="checkbox " name="reason[] "
                                                        value="Mức lương không phù hợp "> <span
                                                ...
                                                <label class="checkbox ">
                                                    <input type="checkbox " name="reason[] "
                                                        value="Địa điểm không phù hợp "> <span
                                                ...
                                                <label class="checkbox ">
                                                    <input type="checkbox " name="reason[] "
                                                        value="Ứng tuyển nhầm công việc "> <span
