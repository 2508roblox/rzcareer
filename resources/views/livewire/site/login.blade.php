...
<form wire:submit.prevent="login" class="login-form">
    <a title="RZCareer - Trang chủ" href="/" class="site-logo" style="justify-content: center; display: flex;">
    ...
    <div class="panel panel-body">
        ...
        <div class="form-group">
            ...
            <button onclick="window.location.href='{{ route('google.login', ['id' => 1]) }}'" class="btn btn-warning btn-block w-100" type="button" id="loginWithGoogle">
