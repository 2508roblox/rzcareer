                ...
                $(document).ready(function($) {
                    ...
                    owl.owlCarousel({
                        ...
                        <section class="section padd-top-25 padd-bot-10">
                            <div class="container">
                                <h4 class="text-upercase"
                                    style="font-weight:bolder;font-size:18px; margin-bottom: 15px;">Các công ty
                                ...
                                <style>
                                    ...
                                    .box-top-employer .teks-item:hover,
                                    .box-top-employer .teks-item.active {
                        ...
                        <section class="section wrap-1">
                                ...
                                <div class="row no-mrg-bk">
                                    <div class="col-sm-12">
                                        <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                            ...
                                            <li itemprop="itemListElement" itemscope=""
                                                itemtype="https://schema.org/ListItem"><a href="/cong-ty.html"
                                                    itemtype="https://schema.org/Thing" itemprop="item"> <span
                            ...
                            class="btn-colorgb-float btn-warning hide"> <i class="fa fa-search-plus icon-float"></i>
                            <span>TÌM NHÂN
                                TÀI</span> </a>
