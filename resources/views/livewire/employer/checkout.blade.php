<div>
    ...
    <head>
        ...
        <meta name="author" content="RZcareer" />
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="text-left text-bold"> Hiển thị HOT JOB trong box
                                                            "Việc Tuyển Gấp" trên Trang chủ RZcareer.vn</td>
                                                        <td>30 Ngày</td>
                                                        <td>15 Ngày</td>
                                                        <td>20 Ngày</td>
                                                        <td>10 Ngày</td>
                                                    ...
                                                    <tr>
                                                        <td class="text-left text-bold"> Hiển thị ưu tiên ngành nghề của
                                                            job (tối đa 3 ngành nghề) trên website tuyển dụng RZcareer.vn.
                                                        </td>
                                                        <td>30 Ngày</td>
                                                        <td>15 Ngày</td>
                                                        <td>10 Ngày</td>
                                                    ...
                                                    <tr>
                                                        <td class="text-left text-bold"> Tin đăng hiển thị đồng thời
                                                            trên 02 trang liên kết với RZcareer là Jobstreet & Indeed</td>
                                                        <td><img src="media/img/check.png" style="width: 30px" alt="">
                                                        </td>
                                                        <td><img src="media/img/check.png" style="width: 30px" alt="">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="text-left text-bold"> RZcareer tư vấn để tối ưu hóa nội
                                                            dung tin đăng</td>
                                                        <td><img src="media/img/check.png" style="width: 30px" alt="">
                                                        </td>
                                                        <td><img src="media/img/check.png" style="width: 30px" alt="">
                        ...
                        <div class="modal-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-bordered text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-left">RZcareer sẽ sử dụng 100% ngân sách đã chi trả của Doanh
