<div>
   ...
   Theo dõi và quản lý công nợ/doanh số, đối chiếu sổ sách và h... #18748470984">
                ...
                <body class="page-job-detail ">
                    ...
                    <nav class="navbar navbar-default navbar-transparent">
                        <div class="container">
                            ...
                            <div class="navbar-header"><a class="navbar-brand" href="/">
                                    <img width="134" height="40" loading="lazy" src="/logo.png"
                                        alt="JobsGO">
                                </a>
                                <div class="visible-xs"
                                    ...
                                    <a href="/site/download?utm_source=web_ntv&utm_medium=top_menu_tai_app"
                                        title="Tải App" target="_blank" style="color: #fff !important;"><i
                                    ...
                                    <li class="dropdown dropdown-user">
                                        <a href="/candidate/index"
                                            ...
                                            <img loading="lazy" width="32"
                                                onerror="this.src='/bolt/assets/images/image.png'"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li><a href="/candidate/pre-profile?tab=manage-resume"
                                                    title="Hồ sơ xin việc"><i class='bx bx-list-ul'></i> Quản lý hồ
                                                    sơ</a></li>
                                            <li><a href="/candidate/profile" title="Hồ sơ xin việc"><i
                                                        class='bx bx-edit'></i> Cập nhật hồ sơ</a></li>
                                            <li><a data-caption="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng"
                                                    target="_blank" href="/candidate/detail?v=1727319141"
                                            ...
                                            <li><a data-caption="Danh sách nhà tuyển dụng đã xem hồ sơ của bạn"
                                            ...
                                            <li class="divider"></li>
                                            <li><a href="/candidate/video-clip"
                                                    title="Video/Clip giới thiệu bản thân"><i class='bx bx-video'></i>
                                                    Video CV</a></li>
                                            ...
                                            <li><a href="javascript: void(0)">
                                                    <div class="switcher"><input type="checkbox" id="switch__input"
                                                            ...
                                                            id="switch__label" class="switch__label status_on">Đang
                                                            tìm việc</label></div>
                                                </a></li>
                                            <li class="divider"></li>
                    ...
                    <link href="/bolt/assets/js/plugins/fancybox-master/dist/jquery.fancybox.min.css?v=234208153092"
                                        ...
                                        <div class="col-sm-8 pr0 job-detail-col-1">
                                            ...
                                            <div class="panel panel-flat">
                                                ...
                                                <div class="panel-body">
                                                        ...
                                                        <div class="breadcrumb-line mt-10">
                                                            <ol class="breadcrumb" itemscope
                                                                ...
                                                                <li class="active">
                                                                    ...
                                                                    <span>{{ $jobPost->career->name }}</span>
                                                                </li>
                                                                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                                                        <a href="{{ url('viec-lam/' . $jobPost->slug) }}" itemtype="https://schema.org/Thing" itemprop="item">
                                                                            <span itemprop="name">{{ $jobPost->job_name }}</span>
                                                                        </a>
                                                    ...
                                                    <div
                                                        class="media stack-media-on-mobile text-left content-group pb-0 mrg-top-10">
                                                        <div class="media-body-2">
                                                            <h1 class="media-heading text-semibold">[Thành phố]{{ $jobPost->job_name }} </h1>

                                                            <ul class="list-inline text-muted mrg-bot-5">
                                                                <li>
                                                                    <i class="bx bx-time-five"></i> <span>Hết hạn trong</span>
                                                                    <span class="deadline">{{ round(\Carbon\Carbon::parse($jobPost->deadline)->diffInDays(now())) }} </span>
                                                                    <span>ngày nữa</span>
                                                                </li>
                                                                <li>
                                                                    <i class="bx bx-money"></i> <span>Mức lương</span>
                                                                    <span class="salary">{{ round(($jobPost->salary_min + $jobPost->salary_max) / 1000000, 2) }} triệu</span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <div id="teksCollaboratives" class="mt-20 hide">
                                                            <div class="panel-bk panel-flat mrg-top-25">
                                                                ...
                                                                <ul
                                                                    class="media-list jobs collaboratives media-list-linked media-list-bordered list-croll">
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 col-md-4">
                                                            <div class="content-group">
                                                                <img class="pull-left" width="44" height="44"
                                                                    loading="lazy"
                                                                    src="/assets_livewire/img/2024/ic19.svg"
                                                                    alt="JobsGo">
                                                                <p class="h5 text-semibold">Tính chất công việc</p>
                                                                <p>{{ $jobPost->type_of_workplace }}</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6 col-md-4">
                                                            <div class="content-group">
                                                                <img class="pull-left" width="44" height="44"
                                                                    loading="lazy"
                                                                    src="/assets_livewire/img/2024/ic20.svg"
                                                                    alt="JobsGo">
                                                        ...
                                                        <div class="col-sm-6 col-md-4">
                                                            <div class="content-group">
                                                                <img class="pull-left" width="44" height="44"
                                                                    loading="lazy"
                                                                    src="/assets_livewire/img/2024/ic21.svg"
                                                                    alt="JobsGo">
                                                                <p class="h5 text-semibold">Yêu cầu bằng cấp
                                                                    <small>(tối thiểu)</small></p>
                                                                <p>{{ $jobPost->academic_level }}</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6 col-md-4">
                                                            <div class="content-group">
                                                                <img class="pull-left" width="44" height="44"
                                                                    loading="lazy"
                                                                    src="/assets_livewire/img/2024/ic22.svg"
                                                                    alt="JobsGo">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="content-group">
                                                                <img class="pull-left" width="44" height="44"
                                                                    loading="lazy"
                                                                    src="/assets_livewire/img/2024/ic24.svg"
                                                                    alt="JobsGo">
                                                    ...
                                                    <p class="mb-20 mt-20 box-warning"><i
                                                       ...
                                                       <div class="media">
                                                           <div class="media-left">
                                                               <a href="{{ url('cong-ty/' . $jobPost->company->slug) }}" class="profile-thumb">
                                                                ...
                                                                <div class="media-body">
                                                                    <h5 class="hide" style="margin-bottom: 0;">
                                                                        <small class="display-block">Mời bạn đến làm việc ở</small>
                                                                    </h5>
                                                        ...
                                                        <div class="company-info text-grey">
                                                            <div class="padd-20 padd-t-0">
                                                                <div>
                                                                    <div><i class="bx bx-sm bx-briefcase"></i> Lĩnh vực:</div>
                                                                    <span>{{ $jobPost->career->name ?? 'Chưa có thông tin' }}</span> <!-- Kiểm tra null -->
                                                                </div>
                                                                <div>
                                                            ...
                                                            <div class="panel-bk panel-flat mrg-top-0"
                                                                ...
                                                                <ul
                                                                    ...
                                                                    <li title="Kế Toán Nội Bộ (Đức Hoà, Long An)"
                                                                        class="col-sm-6 media standard"> <a
                                                                            href="/viec-lam/ke-toan-noi-bo-duc-hoa-long-an-18749000565.html?utm_source=&utm_medium=job_similar&utm_term=job_detail"
                                                                            class="media-link">
                                                                            <div class="media-left"><img
                                                                                    width="69" height="69"
                                                                                    onerror="this.src='/img/cj.jpg'"
                                                                                    loading="lazy"
                                                                                    src="https://jobsgo.vn/media/img/employer/39234-200x200.jpg?v=1623656960"
                                                                                    class="img-md" alt="39234">
                                                                            </div>
                                                                            <div class="media-body"><span
                                                                                    class="h6 media-heading">Kế Toán
                                                                                    Nội Bộ (Đức Hoà, Long
                                                                                    An)</span><small
                                                                                    class="text-muted">Công Ty TNHH Chế
                                                                                    Biến Nước Chấm Mekong</small>
                                                                                <p class="text-muted">
                                                                                    <span
                                                                                        class="btn text-uppercase btn-xs btn-default"><i
                                                                                            class="bx bx-map"></i> Long
                                            ...
                                            <form id="w0" class="bg-fffaf2"
                                                ...
                                                <div class="form-group field-reportform-verifycode required">
                                                    ...
                                                    <img id="reportform-verifycode-image"
                                                        src="/site/captcha?v=66f4cc658a0515.28674991"
                                                        alt=""> <input type="text"
                                                        id="reportform-verifycode" class="form-control"
                                                        name="ReportForm[verifyCode]" aria-required="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        ...
                                        <h5 style="font-size: 16px;font-weight: 500">Bạn có chắc chắn muốn ứng tuyển?
                                        </h5>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                        ...
                                        <div class="col-sm-12">
                                            <form id="w1" class="bg-fffaf2"
                                                ...
                                                <div class="radio"><label><input type="radio" name="cv"
                                                    ...
                                                    class="btn text-uppercase btn-block bg-orange btn-ladda btn-ladda-spinner btn-ladda-progress"
                                                    data-style="zoom-out"><b><i
                                                            class="glyphicon glyphicon-send"></i></b> Xác nhận ứng
                                                    tuyển</button>
                                            </form>
                                        </div>
                                    </div>
