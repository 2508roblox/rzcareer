<div>
        ...
        <div>
            <div>
                ...
                <head>
                    ...
                    <meta property="og:sitename" content="RZCar - Tuyển dụng">
   ...
   Theo dõi và quản lý công nợ/doanh số, đối chiếu sổ sách và h... #18748470984">
                    ...
                    <meta property="al:android:app_name" content="RZCar">
                    <meta property="al:ios:url"
                        content="hope://job/1378228?job_id=1378228&amp;referal_id=&amp;transaction_id=7053142539031728&amp;action_type=view_job">
                    <meta property="al:ios:app_store_id" content="1234120247">
                    <meta property="al:ios:app_name" content="RZCar">
                ...
                <body class="page-job-detail ">
                    ...
                    <a class="hide smart-banner-bk" target="_blank"
                        href="/site/download?utm_source=web_ntv&utm_medium=mobile_banner"><img width="500" height="100"
                            ...
                            alt="Tải app RZCar" src="/assets_livewire/media/img/500x100-banner-2.gif"
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="media-body-2">
                                                            <h1 class="media-heading text-semibold">[Thành
                                                                phố]{{ $jobPost->job_name }} </h1>
                                                            ...
                                                            <div class="panel-bk panel-flat mrg-top-25">
                                                                <div class="panel-heading-bk">
                                                                    <h6
                                                                        ...
                                                                        RZCar còn rất nhiều công việc tương tự để bạn
                                                            ...
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body">
                                                                    <h5 class="hide" style="margin-bottom: 0;">
                                                                        <small class="display-block">Mời bạn đến làm
                                                                            việc ở</small>
                                                                    </h5>
                                                                    <h2 style="font-size: 17px;">
                                                                        <a class="text-uppercase"
                                                                            style="color: #111!important;font-weight: bold;"
                        ...
                        <div class="container">
                            <div class="bg-e4faff position-relative shadow rounded-4 py-4">
                                ...
                                <div class="section-intro px-3 text-dark mb-1 single-col-max mx-auto">Tìm việc hiệu
                                    quả bằng cách tải RZCar về di động của bạn và sẵn sàng nhận việc làm ngay hôm nay!
                                </div>
                                            ...
                                            <div class="textwidget">
                                                <p><strong class="text-body">Văn phòng Miền Bắc:</strong> Tầng 3 tòa
                                                    G1 <br> Five Star Garden, Thanh Xuân, Hà Nội <br>Điện thoại: <a
                                                        class="text-primary" title="RZCar Miền Bắc"
                                                ...
                                                <p><strong class="text-body">Văn phòng Miền Nam:</strong> Lầu 5,
                                                    ...
                                                    <br>Điện thoại: <a class="text-primary" title="RZCar Miền Nam"
                                            ...
                                            <div class="textwidget">
                                                ...
                                                <ul class="footer-social visible-xs d-block d-sm-none list-inline mb-1">
                                                    <li class="list-inline-item"><a
                                                            href="https://www.facebook.com/RZCarVN/" target="_blank"><i
                                    ...
                                    <div class="col-12 col-sm-10">
                                        <ul class="list-inline list-unstyled mb-1 text-primary">
                                            ...
                                            <li class="list-inline-item"><a rel="nofollow" target="_blank"
                                                    ...
                                                    title="RZCar dành cho Nhà tuyển dụng tìm kiếm nhân sự"><u>Dành
                                ...
                                <div class="row">
                                    <div class="col-sm-10">
                                        <p class="pull-left small text-body">Số ĐKKD:‎‎ 0108266100, cấp ngày
                                            ...
                                            thông cấp ngày 30/08/2021.<br /> © 2024 Công ty Cổ phần RZCar. All Rights
                                            Reserved.</p>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="text-center">
                                            <a target="_blank" rel="nofollow"
                                                ...
                                                <img class="lazy"
                                                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                    data-src="/assets_livewire/teks/img/online-gov.svg" alt="RZCar"
                                                    width="100" height="38">
                                            ...
                                            <a target="_blank" rel="nofollow"
                                                ...
                                                <img class="lazy"
                                                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                    data-src="/assets_livewire/teks/img/dmca.svg" alt="RZCar"
                                                    width="100" height="21">
                    ...
                    <a href="/mau-cv-xin-viec.html" title="Tạo CV / Resume Online nhanh chóng, miễn phí với RZCar "
