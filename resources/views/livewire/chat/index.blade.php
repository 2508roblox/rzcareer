...
<body>
    ...
    <div
        class="fixed h-full flex bg-white border lg:shadow-sm overflow-hidden inset-0 lg:top-24 lg:inset-x-1 lg:h-[90%] rounded-t-lg">

        <div class="w-full md:w-[320px] xl:w-[400px] overflow-y-auto shrink-0 h-full border">
        ...
        <div class="hidden md:grid   w-full border-l h-full relative overflow-y-auto" style="contain:content">
            ...
            <div class="m-auto text-center justify-center flex flex-col gap-3 relative">
