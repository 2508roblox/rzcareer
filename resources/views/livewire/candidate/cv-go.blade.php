                    ...
                    <div class="wrap">
                        <div class="navbar-header">
                            ...
                            <ul class="nav navbar-nav pull-right visible-xs-block">
                                <li><a data-toggle="collapse" data-target="#navbar-mobile"><i class="icon-menu7"></i></a></li>
                            </ul>
                            <div class="visible-xs" style="position: absolute;right: 70px;top: 17px;padding: 4px 6px;border-radius: 4px;background-color: #ff5c35; padding: 4px 20px; border-radius: 3px; line-height: 22px;"><a href="/site/download?utm_source=web_ntv&amp;utm_medium=top_menu_tai_app" title="Tải App" target="_blank" style="color: #fff !important;"><i class="glyphicon glyphicon-download-alt" style="color: #fff !important;"></i> Tải App</a></div>
                        </div>

                        <div class="navbar-collapse collapse" id="navbar-mobile">

                            <ul class="nav navbar-nav navbar-left">
                                <li class="hidden-xs"><a style="color: #fff !important;background-color: #ff5c35; padding: 5px 10px; margin-right: 10px; border-radius: 3px; position: relative; height: 30px; top: 16px;" href="/site/download?utm_source=web_ntv&amp;utm_medium=top_menu_tai_app" title="Tải App" target="_blank"><i class="glyphicon glyphicon-download-alt"></i> Tải App</a></li>
                            ...
                            <ul class="nav navbar-nav navbar-right" style="float:right !important;">
                                ...
                                <li class="dropdown dropdown-user">
                                    ...
                                    <a href="candidate/index" style=" padding-top: 12px;display: flex; align-items:center " class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <span>
                                            web developer <div id="status_job_search" class="status_on">Đang tìm việc</div>
                                        </span>
                                    </a>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li><a data-caption="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng" target="_blank" href="/candidate/detail?v=1727350680" title="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng"><i class='bx bx-user-pin'></i> Xem / tải về hồ sơ</a></li>
                                        <li class="divider"></li>
                    ...
                    <div class="page-content">
                        ...
                        <div class="content-wrapper">
                            ...
                            <script>
                                $(document).ready(function() {
                                    ...
                                    $('#phoneAuthModal').on('hidden.bs.modal', function() {
                                        setCookie('jobsgo-tel-verify', 1, 1);
                                    });

                                    var phoneNumber;
                                    var verificationId;

                                    // Show the popup modal when the button is clicked
                                    if (!getCookie('jobsgo-tel-verify')) {
                                        //$("#phoneAuthModal").modal("show");
                                    }

                                    // Handle form submission
                                    $("#phoneAuthForm").submit(function(event) {
                                        event.preventDefault();
                                        phoneNumber = $("#phoneNumber").val().replace(/^(84|0)/, '84').replace(/\D/g, '');
                                        ...
                                        $.post("/api/verify-zalo", {
                                            ...
                                            function(data) {
                                                if (data == 1) {
                                                    colorgbJGrowl('bg-warning', 'Vui lòng kiểm tra Zalo để lấy mã xác thực');
                                                    $("#otpVerificationModal").modal("show");

                                                } else {
                                                    colorgbJGrowl('bg-warning', 'Không thể xác minh, vui lòng thử lại sau');
                                                }
                                    ...
                                    $("#otpVerificationForm").submit(function(event) {
                                        ...
                                        var phoneNumber = $("#phoneNumber").val().replace(/^(84|0)/, '84').replace(/\D/g, '');

                                        $.post("/api/verify-zalo-otp", {
                                                code: code,
                                                phone: phoneNumber,
                                            },
                                            function(data) {
                                                if (data == 1) {
                                                    colorgbJGrowl('bg-success', 'Xác minh SĐT thành công');
                                                    location.reload();

                                                } else {
                                                    colorgbJGrowl('bg-warning', 'Mã xác thực không đúng hoặc đã hết hạn');
                                                }
                            ...
                            <div class="btn-group mb-20 btn-links hide" style="width:100%; text-align: center">
                                ...
                                <a href="candidate/pre-profile?tab=review"
                                ...
                                <a href="candidate/pre-profile?tab=analyze"
                                    ...
                                    tích CV</a>
                                <a href="candidate/pre-profile?tab=cv-go" class="border-primary text-uppercase text-bold btn  btn-primary current"><i
                                        class="fa fa-user"></i> Chọn Mẫu CV</a>
                            </div>

                            <nav>
                                <ol class="cd-breadcrumb triangle custom-icons no-margin-top">
                                    <li class="btn-default"><a href="/candidate/dashboard">
                                    ...
                                    <li class="btn-default"><a href="candidate/pre-profile?tab=manage-resume">
                                            <div class="nav-item"><i class="fa fa-tasks"></i> Quản lý hồ sơ</div>
                                        </a></li>
                                    <li class="btn-default"><a href="candidate/import-cv-data">
                                            <div class="nav-item"><i class="fa fa-upload"></i> Tải lên CV có sẵn</div>
                                        </a></li>
                                    <li class="btn-default"><a href="candidate/pre-profile?tab=review">
                                            <div class="nav-item"><i class="fa fa-exclamation-triangle"></i> Cập nhật hồ sơ <div style="position:absolute;top:-5px;right:0px;font-size:9px;color:white;background:#ff5722;border-radius: 9px;width: 16px;height: 16px;line-height: 16px;;text-align:center">67</div>
                                            </div>
                                        </a></li>
                                    <li class="btn-default"><a href="candidate/pre-profile?tab=analyze">
                                            <div class="nav-item"><i class="fa fa-list-alt"></i> Phân tích hồ sơ</div>
                                        </a></li>
                                    <li class="btn-default"><a href="candidate/pre-profile?tab=self-growth">
                                            <div class="nav-item"><i class="fa fa-user"></i> Phát triển bản thân</div>
                                        </a></li>
                                    <li class="btn-primary current"><a href="candidate/pre-profile?tab=cv-go">
    ...
    -------------------------------- */
                            ...
                            <script>
                                function applyMobileStyles() {
                                    ...
                                    if (isMobile) {
                                        const navItems = document.querySelectorAll('.cd-breadcrumb li a');
                                        const childItems = document.querySelectorAll('.cd-breadcrumb li a .nav-item');
                                        const screenWidth = window.innerWidth;
                                        const halfScreenWidth = screenWidth / 2;

                                        const addMobileCSS = (element) => {
                                            element.style.width = `${halfScreenWidth - 15}px`;
                                            element.style.fontSize = `12px`;
                                        };

                                        navItems.forEach(addMobileCSS);

                                        const lastItem = navItems[navItems.length - 1];
                                        lastItem.style.width = `${halfScreenWidth}px`;
                                        ...
                                        styleElement.appendChild(document.createTextNode('.nav-item {margin-bottom: 3px !important; margin-top: 4px}'));
                                ...
                                function closeAlertUpdateCv() {
                                    $(".notification-update-cv").css("display", "none");

                                    const expirationDate = new Date();
                                    expirationDate.setDate(expirationDate.getDate() + 7);

                                    $.cookie('alertNotificationUpdateCvHidden', 'true', {
                                ...
                                $(document).ready(function() {
                                    const alertNotificationUpdateCvHidden = $.cookie('alertNotificationUpdateCvHidden');

                                    if (!alertNotificationUpdateCvHidden) {
                                        $(".notification-update-cv").css("display", "block");
                                    }
                                })
                            </script>
                            <script>
                                $(function() {
                                    ...
                                    $('.btn-links a[href="candidate/pre-profile?tab=review"]').click(function(e) {
                                        e.preventDefault();
                                    ...
                                    $('.btn-links a[href="candidate/pre-profile?tab=cv-go"]').click(async function(e) {
                                        e.preventDefault();
                                        $('.btn-links > a').removeClass('btn-primary');
                                        $(this).addClass('btn-primary');
                                    ...
                                    $('.btn-links a[href="candidate/pre-profile?tab=manage-resume"]').click(async function(e) {
                                        e.preventDefault();
                                        $('.btn-links > a').removeClass('btn-primary');
                                        $(this).addClass('btn-primary');
                                ...
                                <div class="row add-new-cv">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="content-group">
                                            ...
                                            <!--        </div>-->
                                            <!--    </div>-->
                                            <div class="search-results-list mrg-bot-20 clearfix">
                                                <div class="row">
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            <div class="ribbon-container">
                                                                <div class="ribbon bg-success-400">Miễn phí</div>
                                                            </div>
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_42.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_42.png"
                                                                        type="image/png">
                                                                ...
                                                                <div class="caption-overflow"><span> <a
                                                                            ...
                                                                            class="btn border-white text-white btn-flat btn-icon"> <i
                                                                                class="fa fa-pencil-square-o text-success"></i> Sử dụng mẫu này </a> </span>
                                                                </div>
                                                            </div>
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=42"
                                                                        class="text-default">Mẫu CV Sale Manager</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_41.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_41.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=41"
                                                                        class="text-default">Mẫu CV Thiết Kế Đồ Hoạ</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_31.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_31.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=31"
                                                                        class="text-default">Mẫu CV Tối Giản 3</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_30.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_30.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=30"
                                                                        class="text-default">Mẫu CV Hiện Đại 2</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_29.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_29.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=29"
                                                                        class="text-default">Mẫu CV Thanh Lịch 3</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_28.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_28.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=28"
                                                                        class="text-default">Mẫu CV Outstanding 2</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_27.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_27.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=27"
                                                                        class="text-default">Mẫu CV Độc Đáo 3</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_26.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_26.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=26"
                                                                        class="text-default">Mẫu CV Cá Tính 3</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_25.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_25.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=25"
                                                                        class="text-default">Mẫu CV Độc Đáo 2</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_24.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_24.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=24"
                                                                        class="text-default">Mẫu CV Thanh Lịch 2</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_23.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_23.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=23"
                                                                        class="text-default">Mẫu CV Tối Giản 2</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_22.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_22.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=22"
                                                                        class="text-default">Mẫu CV Sáng Tạo 2</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_21.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_21.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=21"
                                                                        class="text-default">Mẫu CV Ấn Tượng 3</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_20.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_20.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=20"
                                                                        class="text-default">Mẫu CV Cá Tính 2</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_19.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_19.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=19"
                                                                        class="text-default">Mẫu CV Cá Tính 1</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_17.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_17.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=17"
                                                                        class="text-default">Mẫu CV Hiện Đại</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_16.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_16.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=16"
                                                                        class="text-default">Mẫu CV IT Phần cứng</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_15.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_15.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=15"
                                                                        class="text-default">Mẫu CV Outstanding</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_14.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_14.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=14"
                                                                        class="text-default">Mẫu CV Dòng Thời Gian</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_12.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_12.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=12"
                                                                        class="text-default">Mẫu CV Tối Giản</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_11.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_11.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=11"
                                                                        class="text-default">Mẫu CV Sáng Tạo</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_10.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_10.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=10"
                                                                        class="text-default">Mẫu CV Lập Trình Viên</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_9.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_9.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=9"
                                                                        class="text-default">Mẫu CV Marketing</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_8.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_8.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=8"
                                                                        class="text-default">Mẫu CV Độc Đáo</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_7.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_7.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=7"
                                                                        class="text-default">Mẫu CV Senior</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_6.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_6.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=6"
                                                                        class="text-default">Mẫu CV Chuyên Nghiệp 2</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_5.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_5.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=5"
                                                                        class="text-default">Mẫu CV Chuyên Nghiệp 1</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_4.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_4.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=4"
                                                                        class="text-default">Mẫu CV Ấn Tượng 2</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_3.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_3.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=3"
                                                                        class="text-default">Mẫu CV Ấn Tượng 1</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_2.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/theme_2.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=2"
                                                                        class="text-default">Mẫu CV Tiêu Chuẩn 2</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="thumb">
                                                                <picture>
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/default.webp"
                                                                        type="image/webp">
                                                                    <source srcset="/assets_livewire/cv_template/assets/images/theme/default.png"
                                                                        type="image/png">
                                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                            ...
                                                            <div class="caption">
                                                                <h6 class="text-bold"><a
                                                                        href="https://jobsgo.vn/create-resume?theme=1"
                                                                        class="text-default">Mẫu CV Tiêu Chuẩn 1</a></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <style>
                                ...
                                .box-cjcs h6 .pull-right {
                                    display: none;
                                }

                                .box-cjcs h6 .pull-right .btn {
                                    padding: 2px 8px;
                                }
                                ...
                                @media all and (max-width: 768px) {
                                    ...
                                    .box-row:hover .heading-elements {
                                        display: block !important;
                                    }
                            ...
                            <script>
                                $(function() {
                                    ...
                                    $("#colorgbModal131 .item-jcc a").click(function() {
                                        var t = $(this);
                                        var id = t.data('id');
                                        t.parent().addClass('hide');
                                        $.ajax({
                                            url: "/api/set-cp?id=" + id,
                                            success: function(result) {
                                                colorgbJGrowl('bg-success', 'Địa điểm được thêm vào thành công');
                                                f132();
                                            }
                                        });
                                    ...
                                    $('#colorgbModal131').on('hide.bs.modal', function() {
                                        f132();
                                    });
                                ...
                                function f132() {
                                    $.ajax({
                                        url: "/api/get-cp",
                                        success: function(result) {
                                            $(".box-132 .colorgb-row").html(result);
                                            $('.box-132 .colorgb-row .btn-del-cjc').on('click.krajee', function(e, options) {
                                                var t = $(this),
                                                    lib = window['krajeeDialog'];
                                                var msg = 'Bạn có chắc muốn xóa địa điểm này?';
                                                ...
                                                lib.confirm(msg, function(result) {
                                                    ...
                                                    $('#colorgbModal131 .item-jcc a[data-id="' + t.data('iid') + '"]').parent().removeClass('hide');

                                                    $.ajax({
                                                        url: "/api/del-cp?id=" + t.data('id'),
                                                        success: function(result) {
                                                            colorgbJGrowl('bg-success', 'Xóa địa điểm thành công');
                                                            f132();
                                                        }
                                                    });
                            ...
                            <script>
                                $(function() {
                                    ...
                                    $.each({
                                        ...
                                        "Nh\u00e2n Vi\u00ean\/Chuy\u00ean Vi\u00ean": "Nh\u00e2n Vi\u00ean\/Chuy\u00ean Vi\u00ean",
                                        "Tr\u01b0\u1edfng Nh\u00f3m\/Tr\u01b0\u1edfng Ph\u00f2ng": "Tr\u01b0\u1edfng Nh\u00f3m\/Tr\u01b0\u1edfng Ph\u00f2ng",
                                        "Gi\u00e1m \u0110\u1ed1c V\u00e0 C\u1ea5p Cao H\u01a1n": "Gi\u00e1m \u0110\u1ed1c V\u00e0 C\u1ea5p Cao H\u01a1n"
                                    }, function(k, v) {
                                        jps.push({
                                            value: k,
                                            text: v
                                    ...
                                    $('span[data-name="job_position"]').editable({
                                        type: 'select',
                                        pk: 1,
                                        source: jps,
                                        success: function(response, newValue) {
                                            ...
                                            if (response.status == 1) {
                                                colorgbJGrowl('bg-green', t + ' cập nhật' + response.message);

                                            } else {
                                                colorgbJGrowl('bg-danger', t + ' cập nhật' + response.message);
                                            }
                                        },
                                    ...
                                    $('span.status').editable({
                                        ...
                                        success: function(response, newValue) {
                                            response = $.parseJSON(response);
                                            let originalTitle = $(this).data('original-title');
                                            let statusClass = response.status == 1 && response.mess != 'off' ? 'status_on' : 'status_off';
                                            let statusText = statusClass == 'status_on' ? 'Đang tìm việc' : 'Đã tắt tìm việc';

                                            $('#status_job_search').text(statusText).removeClass('status_on status_off').addClass(statusClass);
                                            $('#switch__input').prop('checked', statusClass == 'status_on');
                                            $('#switch__label').text(statusText).removeClass('status_on status_off').addClass(statusClass);
                                            $('.status').removeClass('status_on status_off').addClass(statusClass);

                                            colorgbJGrowl('bg-green', originalTitle + ' cập nhật ' + response.message);
                                        },
                                        error: function(response, newValue) {
                                            let statusClass = 'status_off';
                                            let statusText = 'Đã tắt tìm việc';
                                            let notificationClass = 'bg-danger';
                                            ...
                                            colorgbJGrowl(notificationClass, originalTitle + ' cập nhật ' + response.message);
                                        },
                                    });
                            ...
                            <script>
                                $(function() {
                                    ...
                                    $('#colorgbModal1 #current').click(function() {
                                        if ($(this).is(':checked')) {
                                            $(this).val(1);
                                            $('#colorgbModal1  #expinfoform-date_end_1').prop('disabled', true);
                                            $('#colorgbModal1  #expinfoform-date_end_2').prop('disabled', true);
                                        } else {
                                            $(this).val(0);
                                            $('#colorgbModal1  #expinfoform-date_end_1').prop('disabled', false);
                                            $('#colorgbModal1  #expinfoform-date_end_2').prop('disabled', false);
                                        }
                                    });


                                    $('.btn[data-id="0"]').click(function() {
                                        $("#tagSuggestions").html('');
                                        $('.form-control').val('');
                                        $('select').val(null).trigger('change');
                                        $('#colorgbModal1 #id').val('');
                                    });

                                    $('#colorgbModal1 .btn-primary').click(function() {

                                        var id = $('#colorgbModal1 #id');
                                        var i1 = $('#colorgbModal1 #expinfoform-job_company');
                                        var i2 = $('#colorgbModal1 #expinfoform-job_title');
                                        var i31 = $('#colorgbModal1 #expinfoform-date_start_1');
                                        var i32 = $('#colorgbModal1 #expinfoform-date_start_2');
                                        var i41 = $('#colorgbModal1 #expinfoform-date_end_1');
                                        var i42 = $('#colorgbModal1 #expinfoform-date_end_2');
                                        var i5 = $('#colorgbModal1 #expinfoform-job_description');
                                        var i6 = $('#colorgbModal1 #current');

                                        if (i1.val() == '') {
                                            i1.focus();
                                            colorgbJGrowl('bg-warning', 'Vui lòng nhập tên công ty đã làm việc');
                                        } else if (i2.val() == '') {
                                            colorgbJGrowl('bg-warning', 'Vui lòng nhập vị trí công việc được đảm nhận');
                                        } else if (i31.val() == '') {
                                            colorgbJGrowl('bg-warning', 'Vui lòng nhập thời gian bắt đầu công việc');
                                        }
                                        /*else if (i4.val() == '') {
                                                       colorgbJGrowl('bg-warning', 'Vui lòng nhập thời gian kết thúc công việc');
                                                   }*/
                                        else if (i5.val() == '' || i5.val().length < 50) {
                                            colorgbJGrowl('bg-warning', 'Vui lòng nhập mô tả về công việc của bạn (tối thiểu 50 ký tự)');
                                        } else {
                                ...
                                function f11() {
                                    $.ajax({
                                        url: "/api/get-cjh",
                                        success: function(result) {
                                            $(".box-cj .box-timeline").html(result);
                                            f12();
                                            //updateReviewPanel();
                                        }
                                    });
                                ...
                                function f12() {
                                    ...
                                    $('.btn-update-cjh').click(function() {
                                        var t = $(this);
                                        var c = $('#colorgbModal1');
                                        $('#tagSuggestions').empty();

                                        c.find('#id').val(t.data('id'));
                                        c.find('#expinfoform-job_company').val(t.data('i1'));
                                        c.find('#expinfoform-job_title').val(t.data('i2'));
                                        c.find('#expinfoform-date_start_1').val(t.data('i31')).trigger('change');
                                        c.find('#expinfoform-date_start_2').val(t.data('i32')).trigger('change');
                                        c.find('#expinfoform-date_end_1').val(t.data('i41')).trigger('change');
                                        c.find('#expinfoform-date_end_2').val(t.data('i42')).trigger('change');
                                        c.find('#expinfoform-job_description').val(t.data('i5'));
                                        if (t.data('i6') == 1) {
                                            c.find('#current').trigger('click');
                                        }

                                    });


                                    $('.btn-del-cjh').on('click.krajee', function(e, options) {
                                        var t = $(this),
                                            lib = window['krajeeDialog'];
                                        var msg = 'Bạn có chắc muốn xóa kinh nghiệm làm việc này?';
                                        ...
                                        lib.confirm(msg, function(result) {
                                            ...
                                            $.ajax({
                                                url: "/api/del-cjh?id=" + t.data('id'),
                                                success: function(result) {
                                                    colorgbJGrowl('bg-success', 'Xóa kinh nghiệm làm việc thành công');
                                                    f11();
                                                    updateSuggestPanel();
                                                    updateReviewPanel();
                                                }
                            ...
                            <script>
                                $(function() {
                                    ...
                                    $('#exp').click(function() {
                                        if ($(this).is(":checked")) {
                                            $.ajax({
                                                url: "api/set-exp?val=1",
                                                success: function(result) {
                                                    colorgbJGrowl('bg-green', result);
                                                }
                                            });
                                        } else {
                                            $.ajax({
                                                url: "api/set-exp?val=0",
                                                success: function(result) {
                                                    colorgbJGrowl('bg-green', result);
                                                }
                                            });
                                    ...
                                    $('#colorgbModal1').on('shown.bs.modal', function() {
                                        $('.date').mask("9999-99");

                                        $("#expinfoform-job_company").easyAutocomplete({
                                            ...
                                            preparePostData: function(data) {
                                                data.phrase = $("#expinfoform-job_company").val();
                                                return data;
                                            },

                                            requestDelay: 400
                                        });
                                        $("#expinfoform-job_title").easyAutocomplete({
                                            ...
                                            preparePostData: function(data) {
                                                data.phrase = $("#expinfoform-job_title").val();
                                                return data;
                                            },
                            ...
                            <script>
                                $(function() {
                                    ...
                                    $('.btn[data-id="0"]').click(function() {
                                        $('#colorgbModal21 #id').val('');
                                    });

                                    $("#ion-start-2").ionRangeSlider({
                                        min: 1,
                                        max: 100,
                                        postfix: " %",
                                    });

                                    $('#colorgbModal21 #current').click(function() {
                                        if ($(this).is(':checked')) {
                                            $(this).val(1);
                                        } else {
                                            $(this).val(0);
                                    ...
                                    $('#colorgbModal21 .btn-primary').click(function() {
                                        var i1 = $('#colorgbModal21 #eduinfoform-school_name');
                                        var i2 = $('#colorgbModal21 #eduinfoform-date_end');
                                        var i3 = $('#colorgbModal21 #eduinfoform-degree_id');
                                        var i4 = $('#colorgbModal21 #eduinfoform-specialization');
                                        var i5 = $('#colorgbModal21 #eduinfoform-hightlight');
                                        var i6 = $('#colorgbModal21 #current');
                                        var id = $('#colorgbModal21 #id');

                                        if (i1.val() == '') {
                                            i1.focus();
                                            colorgbJGrowl('bg-warning', 'Vui lòng nhập tên trường học');
                                        } else if (i2.val() == '') {
                                            colorgbJGrowl('bg-warning', 'Vui lòng nhập năm tốt nghiệp');
                                        } else if (i3.val() == '') {
                                            colorgbJGrowl('bg-warning', 'Vui lòng chọn bằng cấp');
                                        } else if (i4.val() == '') {
                                            i4.focus();
                                            colorgbJGrowl('bg-warning', 'Vui lòng nhập chuyên ngành học');
                                        } else if (i5.val() == '' || i5.val().length < 50) {
                                            i5.focus();
                                            colorgbJGrowl('bg-warning', 'Vui lòng mô tả quá trình học tập (tối thiểu 50 ký tự)');
                                        } else {
                                    ...
                                    $("#colorgbModal24 .item-jcc a").click(function() {
                                        var t = $(this);
                                        var id = t.data('id');
                                        t.parent().addClass('hide');
                                        $.ajax({
                                            url: "/api/set-cl?id=" + id + "&val=50",
                                            success: function(result) {
                                                f3();
                                                $('#colorgbModal24').modal('hide');
                                                $('#colorgbModal23').modal('show');
                                                $('#colorgbModal23 h6').html(t.data('title'));
                                                $('#colorgbModal23 img').attr('src', t.data('img'));
                                                $("#ion-start-2").data("ionRangeSlider").update({
                                                    from: t.data('val'),
                                                    onFinish: function(data) {
                                                        $.ajax({
                                                            url: "/api/set-cl?id=" + id + "&val=" + data.from,
                                                            success: function(result) {
                                                                f3();
                                                                colorgbJGrowl('bg-success', 'Ngôn ngữ đã được cập nhật thành công');
                                                            }
                                                        });
                                    ...
                                    /*$('#colorgbModal23').on('hide.bs.modal', function () {
                                        f3();
                                    });*/
                                ...
                                function f1() {
                                    $.ajax({
                                        url: "/api/get-ce",
                                        success: function(result) {
                                            $(".box-ce .box-timeline").html(result);
                                            f2();
                                        }
                                    });
                                }
                                ...
                                function f2() {
                                    ...
                                    $('.btn-update').click(function() {
                                        var t = $(this);
                                        var c = $('#colorgbModal21');

                                        c.find('#id').val(t.data('id'));
                                        c.find('#eduinfoform-school_name').val(t.data('i1'));
                                        c.find('#eduinfoform-date_end').val(t.data('i2')).trigger('change');
                                        c.find('#eduinfoform-degree_id').val(t.data('i3')).trigger('change');
                                        c.find('#eduinfoform-specialization').val(t.data('i4'));
                                        c.find('#eduinfoform-hightlight').val(t.data('i5'));
                                    ...
                                    $('.btn-add').click(function() {
                                        var t = $(this);
                                        $('#colorgbModal21 #id').val(t.data('id'));
                                    });

                                    $('.btn-del-ce').on('click.krajee', function(e, options) {
                                        var t = $(this),
                                            lib = window['krajeeDialog'];
                                        var msg = 'Bạn có chắc muốn xóa quá trình học tập này?';
                                        ...
                                        lib.confirm(msg, function(result) {
                                            ...
                                            $.ajax({
                                                url: "/api/del-ce?id=" + t.data('id'),
                                                success: function(result) {
                                                    f1();
                                                    colorgbJGrowl('bg-success', 'Xóa quá trình học tập thành công');
                                                    updateReviewPanel();
                                                }
                                            });
                                ...
                                function f3() {
                                    $.ajax({
                                        url: "/api/get-cl",
                                        success: function(result) {
                                            $(".box-2 .colorgb-row").html(result);
                                            f4();
                                            $('.box-2 .row .btn-del-css').on('click.krajee', function(e, options) {
                                                var t = $(this),
                                                    lib = window['krajeeDialog'];
                                                var msg = 'Bạn có chắc muốn xóa ngôn ngữ này?';
                                                ...
                                                lib.confirm(msg, function(result) {
                                                    ...
                                                    t.attr('disabled', 'disabled');
                                                    $('#colorgbModal24 .item-jcc a[data-id="' + t.data('iid') + '"]').parent().removeClass('hide');

                                                    $.ajax({
                                                        url: "/api/del-cl?id=" + t.data('id'),
                                                        success: function(result) {
                                                            f3();
                                                            colorgbJGrowl('bg-success', 'Xóa kỹ năng mềm thành công');
                                                        }
                                                    });
                                ...
                                function f4() {
                                    $(".box-2 .row a").click(function() {
                                        var id = $(this).data('id');
                                        $('#colorgbModal23 h6').html($(this).data('title'));
                                        $('#colorgbModal23 img').attr('src', $(this).data('img'));
                                        $("#ion-start-2").data("ionRangeSlider").update({
                                            from: $(this).data('val'),
                                            onFinish: function(data) {
                                                $.ajax({
                            ...
                            <script>
                                $(function() {
                                    ...
                                    $('#colorgbModal21').on('shown.bs.modal', function() {

                                        $('.date').mask("9999");

                                        $("#eduinfoform-school_name").easyAutocomplete({
                                            ...
                                            preparePostData: function(data) {
                                                data.phrase = $("#eduinfoform-school_name").val();
                                                return data;
                                            },
                                        ...
                                        $("#eduinfoform-specialization").easyAutocomplete({
                                            ...
                                            preparePostData: function(data) {
                                                data.phrase = $("#eduinfoform-specialization").val();
                                                return data;
                                            },
                            ...
                            <div id="colorgbModal31" class="modal" role="dialog">
                                <div class="modal-dialog modal-lg">
                            ...
                            <div id="colorgbModal131" class="modal" role="dialog">
                                <div class="modal-dialog modal-lg">
                            ...
                            <script>
                                $(function() {
                                    ...
                                    $("#colorgbModal31 .item-jcc a").click(function() {
                                        var t = $(this);
                                        var id = t.data('id');
                                        t.parent().addClass('hide');
                                        $.ajax({
                                            url: "/api/set-ch?id=" + id,
                                            success: function(result) {
                                                colorgbJGrowl('bg-success', 'Sở thích được thêm vào thành công');
                                                f32();
                                            }
                                        });
                                    ...
                                    $('#colorgbModal31').on('hide.bs.modal', function() {
                                        f32();
                                    });
                                ...
                                function f32() {
                                    $.ajax({
                                        url: "/api/get-ch",
                                        success: function(result) {
                                            $(".box-32 .colorgb-row").html(result);
                                            $('.box-32 .colorgb-row .btn-del-cjc').on('click.krajee', function(e, options) {
                                                var t = $(this),
                                                    lib = window['krajeeDialog'];
                                                var msg = 'Bạn có chắc muốn xóa sở thích này?';
                                                ...
                                                lib.confirm(msg, function(result) {
                                                    ...
                                                    t.attr('disabled', 'disabled');
                                                    $('#colorgbModal31 .item-jcc a[data-id="' + t.data('iid') + '"]').parent().removeClass('hide');

                                                    $.ajax({
                                                        url: "/api/del-ch?id=" + t.data('id'),
                                                        success: function(result) {
                                                            colorgbJGrowl('bg-success', 'Xóa sở thích thành công');
                                                            f32();
                            ...
                            <div id="colorgbModal53" class="modal" role="dialog">
                                <div class="modal-dialog modal-sm">
                            ...
                            <div id="colorgbModal54" class="modal" role="dialog">
                                <div class="modal-dialog modal-lg">
                            ...
                            <script>
                                $(function() {
                                    ...
                                    $("#colorgbModal54 .item-jcc a").click(function() {
                                        var t = $(this);
                                        var id = t.data('id');
                                        t.parent().addClass('hide');
                                        $.ajax({
                                            url: "/api/set-css?id=" + id + "&val=50",
                                            success: function(result) {
                                                f53();
                                                $('#colorgbModal54').modal('hide');
                                                $('#colorgbModal53').modal('show');
                                                $('#colorgbModal53 h6').html(t.data('title'));
                                                $('#colorgbModal53 img').attr('src', t.data('img'));
                                                $("#ion-start-52").data("ionRangeSlider").update({
                                                    from: t.data('val'),
                                                    onFinish: function(data) {
                                                        $.ajax({
                                                            url: "/api/set-css?id=" + id + "&val=" + data.from,
                                                            success: function(result) {
                                                                f53();
                                                                colorgbJGrowl('bg-success', 'Kỹ năng đã được cập nhật thành công');
                                                            }
                                                        });
                                ...
                                function f51() {
                                    ...
                                    $(".box-52 .row a").click(function() {
                                        var id = $(this).data('id');
                                        $('#colorgbModal53 h6').html($(this).data('title'));
                                        $('#colorgbModal53 img').attr('src', $(this).data('img'));
                                        $("#ion-start-52").data("ionRangeSlider").update({
                                            from: $(this).data('val'),
                                            onFinish: function(data) {
                                                $.ajax({
                                                    ...
                                                    success: function(result) {
                                                        f53();
                                                        colorgbJGrowl('bg-success', 'Kỹ năng mềm đã được cập nhật thành công');
                                                    }
                                                });
                                ...
                                function f53() {
                                    $.ajax({
                                        url: "/api/get-css",
                                        success: function(result) {
                                            $(".box-52 .colorgb-row").html(result);
                                            f51();
                                            $('.box-52 .row .btn-del-css').on('click.krajee', function(e, options) {
                                                var $btn = $(this),
                                                    lib = window['krajeeDialog'];
                                                var msg = 'Bạn có chắc muốn xóa kỹ năng mềm này?';
                                                ...
                                                lib.confirm(msg, function(result) {
                                                    ...
                                                    $('#colorgbModal54 .item-jcc a[data-id="' + $btn.data('id') + '"]').parent().removeClass('hide');

                                                    $.ajax({
                                                        url: "/api/del-css?id=" + $btn.data('id'),
                                                        success: function(result) {
                                                            f53();
                                                            colorgbJGrowl('bg-success', 'Xóa kỹ năng mềm thành công');
                                                        }
                            ...
                            <script>
                                $(function() {
                                    ...
                                    $('#colorgbModal61 .btn-primary').click(function() {
                                        var i1 = $('#colorgbModal61 [name="cid[]"]:last');
                                        var i2 = $('#colorgbModal61 [name="cexp[]"]:last');

                                        if (i1.val() == '') {
                                            i1.focus();
                                            colorgbJGrowl('bg-warning', 'Vui lòng chọn kỹ năng chuyên môn');
                                        } else if (i2.val() == '') {
                                            colorgbJGrowl('bg-warning', 'Vui lòng chọn số năm kinh nghiệm');
                                        } else {

                                            var cids = $('#colorgbModal61 [name="cid[]"]').map(function() {
                                                return $(this).val();
                                            }).get().join(',');
                                            var cexps = $('#colorgbModal61 [name="cexp[]"]').map(function() {
                                                return $(this).val();
                                            }).get().join(',');
                                ...
                                function f60() {
                                    ...
                                    $('.btn-add[data-target="#colorgbModal61"]').click(function() {
                                        var c = $('#colorgbModal61');
                                        $('.btn-clone-row-cjc').removeClass('hide');
                                        c.find('[name="cid[]"]').val('').prop('disabled', false).trigger('change').select2({
                                            placeholder: 'Tìm kiếm...',
                                            ajax: {
                                                url: '/api/job-categories', // Thay thế bằng URL của endpoint AJAX của bạn
                                                dataType: 'json',
                                        ...
                                        c.find('[name="cexp[]"]').val('').prop('disabled', false).trigger('change').select2();
                                    });
                                    $.ajax({
                                        url: "/api/get-cjcs",
                                        success: function(result) {
                                            $(".box-cjcs").html(result);
                                            f62();
                                        }
                                    });
                                ...
                                function f62() {
                                    ...
                                    $('.btn-update-cjcs').click(function() {
                                        var t = $(this);
                                        var c = $('#colorgbModal61');
                                        $('.btn-clone-row-cjc').addClass('hide');
                                        $('#colorgbModal61 .row-cjc select').select2('destroy');
                                        var clonedDiv = $('#colorgbModal61 .row-cjc > .row:nth-child(1)').clone();
                                        $("#colorgbModal61 .row-cjc").html(clonedDiv);
                                        c.find('[name="cid[]"]:first').val(t.data('i1')).prop('disabled', true).trigger('change').select2({
                                        ...
                                        c.find('[name="cexp[]"]:first').val(t.data('i2')).trigger('change').select2();

                                    });


                                    $('.btn-del-cjcs').on('click.krajee', function(e, options) {
                                        var t = $(this),
                                            lib = window['krajeeDialog'];
                                        var msg = 'Bạn có chắc muốn xóa kỹ năng chuyên môn này?';
                                        ...
                                        lib.confirm(msg, function(result) {
                                            ...
                                            $.ajax({
                                                url: "/api/del-cjcs?id=" + t.data('id'),
                                                success: function(result) {
                                                    colorgbJGrowl('bg-success', 'Xóa kỹ năng chuyên môn thành công');
                                                    f60();
                                                    updateReviewPanel();
                                                }
                                            });
                            ...
                            <style>
                                ...
                                .progress-score .progress>.progress-type {
                                    position: absolute;
                                    left: 0px;
                                    font-weight: 600;
                                ...
                                .progress-score .progress>.progress-completed {
                                    position: absolute;
                                    right: 0px;
                                    font-weight: 600;
                                ...
                                .progress-score .progress .progress-left {
                                    left: 0;
                                }

                                .progress-score .progress .progress-bar {
                                    width: 100%;
                                    height: 100%;
                                    background: none;
                                    border-width: 12px;
                                ...
                                .progress-score .progress .progress-left .progress-bar {
                                    left: 100%;
                                ...
                                .progress-score .progress .progress-right {
                                    right: 0;
                                }

                                .progress-score .progress .progress-right .progress-bar {
                                    left: -100%;
                                ...
                                .progress-score .progress .progress-value {
                                    width: 90%;
                                    height: 90%;
                                    border-radius: 50% !important;
                                    background: #44484b;
                                ...
                                .progress.blue .progress-left .progress-bar {
                                    animation: loading-2 .3s linear forwards .8s;
                                }
                            </style>
                            <script>
            ...
            Đang kiểm tra gợi ý từ JobsGO\n\
                                ...
                                function upateSuggestPanelPosition(pos) {
                                    if (pos == 'sticky') {
            ...
            Đang kiểm tra gợi ý từ JobsGO\n\
                                    ...
                                    $('#panel').html(loading);
                                    $.ajax({
                                        url: "/ajax/get-suggest-panel",
                                        method: "POST"
                                    }).done(function(data) {
                                        $('#panel').html(data);
                                        setTimeout(upateSuggestPanelPosition, 3000);
                                    });
                                }

                                function showAddNewCv() {
                                    $(".cv-profile").css("display", "none");
                                    $(".manage-resume").css("display", "none");
                                    $(".add-new-cv").css("display", "block");
                                }

                                function showCvProfile() {
                                    $(".cv-profile").css("display", "block");
                                    $(".add-new-cv").css("display", "none");
                                    $(".manage-resume").css("display", "none");
                                }

                                function showManageResume() {
                                    $(".manage-resume").css("display", "block");
                                    $(".add-new-cv").css("display", "none");
                                    $(".cv-profile").css("display", "none");
                                }
                            ...
                            <script>
                                    ...
                                    var e, i, n, s, r, o = {
                                            ...
                                            throttle: function(t, e) {
                                                ...
                                                return o = 0, u = function() {
                                                    ...
                                                    function() {
                                                        var a = new Date,
                                                            c = e - (a - o);
                                                        return i = this, n = arguments, c <= 0 ? (clearTimeout(s), s = null, o = a, r = t.apply(i, n)) : s || (s = setTimeout(u, c)), r
                                                    }
                                            },
                                        ...
                                        u = (i = /\s+/, {
                                            on: function(t, e) {
                                                var n;
                                                if (!e) return this;
                                                for (this._callbacks = this._callbacks || {}, t = t.split(i); n = t.shift();) this._callbacks[n] = this._callbacks[n] || [], this._callbacks[n].push(e);
                                                return this
                                            },
                                            trigger: function(t, e) {
                                                var n, s;
                                                if (!this._callbacks) return this;
                                                for (t = t.split(i); n = t.shift();)
                                        ...
                                        c = function() {
                                            ...
                                            return e = t && window.JSON ? {
                                                ...
                                                get: function(e) {
                                                    return this.isExpired(e) && this.remove(e), u(t.getItem(this._prefix(e)))
                                                },
                                                set: function(e, i, n) {
                                                    return o.isNumber(n) ? t.setItem(this._ttlKey(e), r(s() + n)) : t.removeItem(this._ttlKey(e)), t.setItem(this._prefix(e), r(i))
                                                },
                                                remove: function(e) {
                                                ...
                                                clear: function() {
                                                    var e, i, n = [],
                                                        s = t.length;
                                                    for (e = 0; e < s; e++)(i = t.key(e)).match(this.keyMatcher) && n.push(i.replace(this.keyMatcher, ""));
                                                    for (e = n.length; e--;) this.remove(n[e]);
                                                    return this
                                                },
                                                isExpired: function(e) {
                                                    var i = u(t.getItem(this._ttlKey(e)));
                                                    return !!(o.isNumber(i) && s() > i)
                                                }
                                            } : {
                                                get: o.noop,
                                                set: o.noop,
                                        ...
                                        l = function() {
                                            ...
                                            function r(t) {
                                                o.bindAll(this), t = o.isString(t) ? {
                                                    url: t
                                                } : t, i = i || new h, e = o.isNumber(t.maxParallelRequests) ? t.maxParallelRequests : e || 6, this.url = t.url, this.wildcard = t.wildcard || "%QUERY", this.filter = t.filter, this.replace = t.replace, this.ajaxSettings = {
                                                    type: "get",
                                                    cache: t.cache,
                                                    timeout: t.timeout,
                                            ...
                                            return o.mixin(r.prototype, {
                                                _get: function(t, s) {
                                                    var r = this;
                                                    n < e ? this._sendRequest(t).done(function e(n) {
                                                        var o = r.filter ? r.filter(n) : n;
                                                        s && s(o), i.set(t, n)
                                                ...
                                                _sendRequest: function(e) {
                                                    var i = this,
                                                        r = s[e];
                                                    return r || (n++, r = s[e] = t.ajax(e, this.ajaxSettings).always(function t() {
                                                        n--, s[e] = null, i.onDeckRequestArgs && (i._get.apply(i, i.onDeckRequestArgs), i.onDeckRequestArgs = null)
                                                    })), r
                                                },
                                                get: function(t, e) {
                                                    var n, s, r = this,
                                                        u = encodeURIComponent(t || "");
                                                    return e = e || o.noop, n = this.replace ? this.replace(this.url, u) : this.url.replace(this.wildcard, u), (s = i.get(n)) ? o.defer(function() {
                                            ...
                                            return o.mixin(i.prototype, {
                                                ...
                                                _loadPrefetchData: function(i) {
                                                    var n, s, r, u, a, c, h = this,
                                                        l = "0.9.3" + (i.thumbprint || "");
                                                    return this.storage && (n = this.storage.get(e.thumbprint), s = this.storage.get(e.protocol), r = this.storage.get(e.itemHash), u = this.storage.get(e.adjacencyList)), a = n !== l || s !== o.getProtocol(), (i = o.isString(i) ? {
                                                        url: i
                                                    } : i).ttl = o.isNumber(i.ttl) ? i.ttl : 864e5, r && u && !a ? (this._mergeProcessedData({
                                                        itemHash: r,
                                                        adjacencyList: u
                                                    }), c = t.Deferred().resolve()) : c = t.getJSON(i.url).done(function t(n) {
                                                        var s = i.filter ? i.filter(n) : n,
                                                            r = h._processData(s),
                                                            u = r.itemHash,
                                                            a = r.adjacencyList;
                                                        h.storage && (h.storage.set(e.itemHash, u, i.ttl), h.storage.set(e.adjacencyList, a, i.ttl), h.storage.set(e.thumbprint, l, i.ttl), h.storage.set(e.protocol, o.getProtocol(), i.ttl)), h._mergeProcessedData(r)
                                                    }), c
                                                },
                                                _transformDatum: function(t) {
                                                    var e = o.isString(t) ? t : t[this.valueKey],
                                                        i = t.tokens || o.tokenizeText(e),
                                                        n = {
                                                            value: e,
                                                            tokens: i
                                                        };
                                                    return o.isString(t) ? (n.datum = {}, n.datum[this.valueKey] = t) : n.datum = t, n.tokens = o.filter(n.tokens, function(t) {
                                                        return !o.isBlankString(t)
                                                    }), n.tokens = o.map(n.tokens, function(t) {
                                                ...
                                                _getLocalSuggestions: function(t) {
                                                    ...
                                                    return (o.each(t, function(t, e) {
                                                        ...
                                                        if (!r) return !1;
                                                        s.push(r), (!e || r.length < e.length) && (e = r)
                                                    }), s.length < n.length) ? [] : (o.each(e, function(e, n) {
                                                        var u, a, c = i.itemHash[n];
                                                        (a = (u = o.every(s, function(t) {
                                                            return ~o.indexOf(t, n)
                                                        })) && o.every(t, function(t) {
                                                            return o.some(c.tokens, function(e) {
                                                ...
                                                getSuggestions: function(t, e) {
                                                    var i, n, s = this,
                                                        r = !1;
                                                    !(t.length < this.minLength) && (i = o.tokenizeQuery(t), (n = this._getLocalSuggestions(i).slice(0, this.limit)).length < this.limit && this.transport && (r = this.transport.get(t, function t(i) {
                                                        n = n.slice(0), o.each(i, function(t, e) {
                                                            var i, r = s._transformDatum(e);
                                                            return (i = o.some(n, function(t) {
                                                                return r.value === t.value
                                                            })) || n.push(r), n.length < s.limit
                                                        }), e && e(n)
                                                    })), !r && e && e(n))
                                                }
                                            }), i
                                        ...
                                        g = function() {
                                            ...
                                            return o.mixin(n.prototype, u, {
                                                ...
                                                _moveCursor: function(t) {
                                                    var e, i, n, r;
                                                    if (this.isVisible()) {
                                                        if ((i = (e = this._getSuggestions()).filter(".tt-is-under-cursor")).removeClass("tt-is-under-cursor"), -1 == (n = ((n = e.index(i) + t) + 1) % (e.length + 1) - 1)) {
                                                            this.trigger("cursorRemoved");
                                                            return
                                                        }
                                                        n < -1 && (n = e.length - 1), r = e.eq(n).addClass("tt-is-under-cursor"), this._ensureVisibility(r), this.trigger("cursorMoved", s(r))
                                                    }
                                                },
                                                ...
                                                _ensureVisibility: function(t) {
                                                    var e = this.$menu.height() + parseInt(this.$menu.css("paddingTop"), 10) + parseInt(this.$menu.css("paddingBottom"), 10),
                                                        ...
                                                        n = t.position().top,
                                                        s = n + t.outerHeight(!0);
                                                    n < 0 ? this.$menu.scrollTop(i + n) : e < s && this.$menu.scrollTop(i + (s - e))
                                                },
                                                destroy: function() {
                                                ...
                                                renderSuggestions: function(n, s) {
                                                    var r, u, a, c, h, l = "tt-dataset-" + n.name,
                                                        d = this.$menu.find("." + l);
                                                    0 === d.length && (u = t(e.suggestionsList).css(i.suggestionsList), d = t("<div></div>").addClass(l).append(n.header).append(u).append(n.footer).appendTo(this.$menu)), s.length > 0 ? (this.isEmpty = !1, this.isOpen && this._show(), a = document.createElement("div"), c = document.createDocumentFragment(), o.each(s, function(e, s) {
                                                        s.dataset = n.name, r = n.template(s.datum), a.innerHTML = '<div class="tt-suggestion">%body</div>'.replace("%body", r), (h = t(a.firstChild).css(i.suggestion).data("suggestion", s)).children().each(function() {
                                                            t(this).css(i.suggestionChild)
                                                        }), c.appendChild(h[0])
                                                    }), d.show().find(".tt-suggestions").html(c)) : this.clearSuggestions(n.name), this.trigger("suggestionsRendered")
                                                },
                                        ...
                                        f = function() {
                                            ...
                                            function n(n) {
                                                var s, r, u;
                                                o.bindAll(this), this.$node = function n(s) {
                                                    var r = t(e.wrapper),
                                                        o = t(e.dropdown),
                                                        u = t(s),
                                                        a = t(e.hint);
                                                    r = r.css(i.wrapper), o = o.css(i.dropdown), a.css(i.hint).css({
                                                    ...
                                                    return u.wrap(r).parent().prepend(a).append(o)
                                                }(n.input), this.datasets = n.datasets, this.dir = null, this.eventBus = n.eventBus, s = this.$node.find(".tt-dropdown-menu"), r = this.$node.find(".tt-query"), u = this.$node.find(".tt-hint"), this.dropdownView = new g({
                                                    menu: s
                                            ...
                                            return o.isMsie() && o.mixin(i.query, {
                                                backgroundImage: "url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)"
                                            }), o.isMsie() && 7 >= o.isMsie() && (o.mixin(i.wrapper, {
                                                display: "inline",
                                                zoom: "1"
                                            }), o.mixin(i.query, {
                                                marginTop: "-1px"
                                            })), o.mixin(n.prototype, u, {
                                                ...
                                                _updateHint: function() {
                                                    var t, e, i, n, s, r = this.dropdownView.getFirstSuggestion(),
                                                        u = r ? r.value : null,
                                                        a = this.dropdownView.isVisible(),
                                                        c = this.inputView.isOverflow();
                                                    u && a && !c && (e = (t = this.inputView.getInputValue()).replace(/\s{2,}/g, " ").replace(/^\s+/g, ""), s = (n = RegExp("^(?:" + (i = o.escapeRegExChars(e)) + ")(.*$)", "i")).exec(u), this.inputView.setHintValue(t + (s ? s[1] : "")))
                                                },
                                                _clearHint: function() {
                                                ...
                                                destroy: function() {
                                                    var t, e;
                                                    this.inputView.destroy(), this.dropdownView.destroy(), e = (t = this.$node).find(".tt-query"), o.each(e.data("ttAttrs"), function(t, i) {
                                        ...
                                        initialize: function(e) {
                                            ...
                                            return 0 === (e = o.isArray(e) ? e : [e]).length && t.error("no datasets provided"), i = o.map(e, function(t) {
                                                ...
                                                n = o.map(i, function(t) {
                                                    ...
                                                    datasets: i
                                                })), t.when.apply(t, n).always(function() {
                                                    o.defer(function() {
                                                        u.trigger("initialized")
                                                    })
                                                })
                                            })
                                        },
                                ...
                                ! function(t) {
                                    "use strict";
                                    var e = function(t) {
                                        this.init("typeaheadjs", t, e.defaults)
                                    };
                                    t.fn.editableutils.inherit(e, t.fn.editabletypes.text), t.extend(e.prototype, {
                                        render: function() {
                                            this.renderClear(), this.setClass(), this.setAttr("placeholder"), this.$input.typeahead(this.options.typeahead), "bs3" === t.fn.editableform.engine && (this.$input.hasClass("input-sm") && this.$input.siblings("input.tt-hint").addClass("input-sm"), this.$input.hasClass("input-lg") && this.$input.siblings("input.tt-hint").addClass("input-lg"))
                                        }
                                    }), e.defaults = t.extend({}, t.fn.editabletypes.list.defaults, {
                                        tpl: '<input type="text">',
                                        typeahead: null,
                                        clear: !0
                                    }), t.fn.editabletypes.typeaheadjs = e
                                }(window.jQuery);
                            </script>
                            <script>
                                $(document).ready(function() {
                                    $('.btn-delete-certificate').on('click', function() {
                                        var certificateId = $(this).data('id');

                                        if (confirm('Bạn có chắc chắn muốn xóa chứng chỉ này không?')) {
                                            $.ajax({
                                                url: '/api/delete-certificate',
                                                type: 'POST',
                                                data: {
                                                    certificate_id: certificateId
                                                },
                                                success: function(response) {
                                                    colorgbJGrowl('bg-success', 'Xoá chứng chỉ thành công!');
                                                    setTimeout(function() {
                                                        location.reload();
                                                    }, 1500);
                                                },
                                                error: function() {
                                                    colorgbJGrowl('bg-error', 'Có lỗi xảy ra. Vui lòng thử lại.');
                                                }
                                            });
                                        }
                                    });
                                        ...
                                        <div class="content-group">
                                            <div class="panel-body bg-blue-800 text-center">
                                                <div class="content-group-sm">
                                                    <a data-caption="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng" data-fancybox data-type="iframe" class="text-white" href="https://jobsgo.vn/candidate/detail?v=1727350680" title="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng">
                    ...
                    function message() {
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                lm.html(obj.lm);
                                boltJs();
                                $('.list-message .media-title a').click(function() {
                    ...
                    $(function() {
                        ...
                        $(window).scroll(function () {
                            if ($(window).scrollTop() > (e.top) && $(window).width() > 1400) {
                                $('.sidebar').css({'position': 'fixed', 'top': '0px', 'width': '260px'});
                            } else {
                ...
                <script src="/event/min.js?v=1727350680"></script>
                <a data-caption="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng" data-fancybox data-type="iframe" href="https://jobsgo.vn/candidate/detail?v=1727350680" title="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng" class="btn-colorgb-float"> <i class="icon-vcard icon-float"></i> <span>Xem / tải về hồ sơ</span> </a>
