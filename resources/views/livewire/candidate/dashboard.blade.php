                                ...
                                function applyMobileStyles() {
                                    ...
                                    if (isMobile) {
                                        ...
                                        styleElement.appendChild(document.createTextNode(
                                            '.nav-item {margin-bottom: 3px !important; margin-top: 4px}'));
                                    ...
                                    <div class="flex-contain">
                                        <div class="flex-left ">
                                            ...
                                            <div class="hide">
                                                ...
                                                <div class="p15 hidden-xs">
                                                    <p class="text-uppercase fontz12 text-muted">Giới thiệu bản thân
                                                        (Video CV)</p>
                                                    <a href="/candidate/video-clip" class="btn btn-primary"><i
                                            ...
                                            <div class="p15 hidden-xs">
                                                ...
                                                <p class="mt-20 mb-0"><a href="/candidate/review"
                                        ...
                                        <div class="flex-center">
                                            <div class="p15">
                                                <div class="ntv-profile-flexcenter-sc1 clearfix mb-20">
                                                    ...
                                                    <a href="/candidate/jobs-applied" class="media">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <!-- Display the count of applied jobs -->
                                                    ...
                                                    <a href="/candidate/jobs-saved" class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <h4>{{ $savedJobsCount }}</h4>
                                                            <!-- Display the number of saved jobs -->
                                                            <span>Việc đã lưu</span>
                                                            <!-- This translates to "Saved Jobs" -->
                                                        </div>
                                                    </a>
                                                ...
                                                <div class="p-5">
                                                    ...
                                                    <div id="myCarousel" class="carousel hide slide mb-20"
                                                        data-ride="carousel">
                                                        <!-- Indicators -->
                                                        ...
                                                        <div class="carousel-inner">
                                                            <div class="item active">
                                                                <a href="/candidate/video-clip">
                                                                    <picture><img src="/media/home/4.png"
                                                                            ...
                                                                            <div class="media">
                                                                                ...
                                                                                <div class="media-body">
                                                                                    ...
                                                                                    <ul>
                                                                                        <li>
                                                                                            <i class="bx bx-map"></i>
                                                                                            {{ $job['city']['name'] ?? 'Chưa có tên' }}
                                                                                        </li>
                                                                                        <li>
                                                                                            <i class="bx bx-money"></i>
                                                                                            {{ number_format($job['salary_min'] / 1_000_000, 0, '.', ',') }}
                                                                                            -
                                                                                            {{ number_format($job['salary_max'] / 1_000_000, 0, '.', ',') }}
                                                                                            triệu VNĐ
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                ...
                                                                <div class="content clearfix">
                                                                    <div id="elementToToggle" style="display: none;">
                                                                        <fieldset id="steps-uid-0-p-0" role="tabpanel"
                                                                            ...
                                                                            <form id="w0"
                                                                                ...
                                                                                action="/candidate/cv" method="post"
                                                                                enctype="multipart/form-data">
                                                                                <input type="hidden"
                                                                                    name="_csrf-jobsgo-candidate"
                                                                                    value="sjtUl-93fuE5sxaXM0TxVnZhILccZTG-ob7Ev9rrDkbIdSWn1iAqjHr1e9RnDJwSJhdu5jEgCevZ9PHWi6A6dg==">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <input type="text"
                                                                                            ...
                                                                                            value="Tài liệu chứng chỉ - Trần Lê Hoàng Giang"
                                                                                            aria-required="true">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        ...
                                                                                        <div class="uploader bg-blue"
                                                                                            id="uniform-cvresumeform-file_upload">
                                                                                            <input type="file"
                                                                                                id="cvresumeform-file_upload"
                                                                                                class="file-styled"
                                                                                                name="CvResumeForm[file_upload]"><span
                                                                                                class="filename"
                                                                                                style="user-select: none;">No
                                                                                                file
                                                                                                selected</span><span
                                                                                                class="action"
                                                                                                style="user-select: none;"><i
                                                                                                    class="icon-file-plus"></i></span>
                                                                                        </div>
                                                                    ...
                                                                    <div class="clearfix">
                                                                        <h6
                                                                            ...
                                                                            <i class="icon-file-media"></i> Danh sách
                                                                            cv đã tải lên
                                                                        </h6>
                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            @foreach ($secondaryResumes as $secondaryResume)
                                                                                ...
                                                                                <div class="col-md-6 col-sm-12">
                                                                                    <article
                                                                                        class="platinum border-none mt-5">
                                                                                        <div class="brows-job-list">
                                                                                            <div class="col-sm-12"
                                                                                                style="box-shadow: 0 0 5px 2px rgba(0, 0, 0, 0.1) !important;
                                                                                        ...
                                                                                        ">
                                                                                            ...
                                                                                            ">
                                                                                                        <a style="overflow: hidden"
                                                                                                            href="/cv-go/RmFkQisydkRIUGhENXE2OWN5Tm1WZz09">
                                                                                                            <iframe
                                                                                                                scrolling="no"
                                                                                                                src="{{ asset($secondaryResume->file_url) }}"
                                                                                                                type="application/pdf"
                                                                                                                class="pdf-preview"
                                                                                                                style="width:56px; height:79px;"></iframe>
                                                                                                        </a>
                                                                                                    </div>
                                                                                                    <div
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer pt-3">
                                                ...
                                                <button type="button" class="btn btn-primary" id="crop">Lưu
                                                    ảnh</button>
                                            </div>
                                        </div>
                                    </div>
