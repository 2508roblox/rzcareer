                    ...
                    <div class="content-wrapper">
                        ...
                        <main>
                            <div class="btn-group mb-20 btn-links hide" style="width:100%; text-align: center">
                                <a href="/candidate/dashboard" class="border-primary text-uppercase text-bold btn btn-primary current"><i class="fa fa-dashboard"></i> Bảng tin</a>
                                <a href="/candidate/manage-resume" class="border-primary text-uppercase text-bold btn btn-default"><i class="fa fa-line-chart"></i> Quản
                                    lý hồ sơ</a>
                                <a href="/candidate/import-cv-data" class="border-primary text-uppercase text-bold btn btn-default"><i class="fa fa-upload"></i> Tải lên CV có sẵn</a>
                                <a href="/candidate/review" class="border-primary text-uppercase text-bold btn btn-default"><i class="fa fa-list-alt"></i> Hoàn
                                    thiện CV <div style="position:absolute;top:-5px;right:0px;font-size:9px;color:white;background:#ff5722;border-radius: 9px;width: 16px;height: 16px;line-height: 16px;;text-align:center">
                                        67</div></a>
                                ...
                                <!--</a>-->
                                <a href="candidate/pre-profile?tab=analyze" class="border-primary text-uppercase text-bold btn btn-default"><i class="fa fa-line-chart"></i> Phân
                                    tích CV</a>
                                <a href="cv-go" class="border-primary text-uppercase text-bold btn  btn-default"><i class="fa fa-user"></i> Chọn Mẫu CV</a>
                            </div>
                                        ...
                                        <div class="flex-left ">
                                            <div class="p15">
                                                <div class="thumbnail" title="Cập nhật ảnh đại diện">
                                                    <div id="imageDropAvatar" class="thumb thumb-slide">
                                                        ...
                                                        <div class="caption">
                                                            <label for="changeAvatar" class="btn bg-success-400 btn-icon btn-xs" data-popup="lightbox"><i class="icon-plus2"></i>
                                            ...
                                            <div class="hide">
                                                ...
                                                <div class="p15 hidden-xs">
                                                    <p class="text-uppercase fontz12 text-muted">Giới thiệu bản thân
                                                        (Video CV)</p>
                                            ...
                                            <div class="p15 hidden-xs">
                                                ...
                                                <p class="mt-20 mb-0"><a wire:navigate href="/candidate/review" class="btn btn-edit-profile"><i class="icofont-ui-edit"></i>
                                                        Cập nhật hồ sơ</a></p>
                                            </div>
                                            ...
                                            {{-- <div class="p15 hidden-xs">
                                                ...
                                                <a href="/candidate/document-attachment" class="btn btn-default"><i
                                     ...
                                     <span class="sr-only">Next</span>
                                                    ...
                                                    <style>
                                                        ...
                                                        .job-grid {
                                                            ...
                                                            gap: 1rem;
                                                            max-width: 800px;
                                                            /* tùy chỉnh theo thiết kế của bạn */
                                                        }
                                                        ...
                                                        .ntv-profile-flexcenter-job-item {
                                                            margin: 0;
                                                        }
                                                    ...
                                                    <div class="panel panel-flat border-card-box">
                                                        <div class="panel-body">
                                                            <h4 class="panel-title">
                                                                <span>Danh sách CV đã tải lên</span>
                                                                <a class="pull-right text-capitalize font-13 text-white btn btn-primary" id="toggleButton_" title="Tải CV mới" href="/candidate/import-cv-data"><span class="glyphicon glyphicon-upload"></span> Tải
                                                                    CV lên</a>
                                                            </h4>
                                                                ...
                                                                <div class="content clearfix">
                                                                    <div id="elementToToggle" style="display: none;">
                                                                        <fieldset id="steps-uid-0-p-0" role="tabpanel" aria-labelledby="steps-uid-0-h-0" class="body current" aria-hidden="false">
                                                                            <form id="w0" class="form-horizontal" action="/candidate/cv" method="post" enctype="multipart/form-data">
                                                                                <input type="hidden" name="_csrf-jobsgo-candidate" value="sjtUl-93fuE5sxaXM0TxVnZhILccZTG-ob7Ev9rrDkbIdSWn1iAqjHr1e9RnDJwSJhdu5jEgCevZ9PHWi6A6dg==">
                                                                                ...
                                                                                <div class="form-group field-cvresumeform-title required">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <input type="text" id="cvresumeform-title" class="form-control" name="CvResumeForm[title]" value="Tài liệu chứng chỉ - Trần Lê Hoàng Giang" aria-required="true">
                                                                                ...
                                                                                <div class="form-group field-cvresumeform-description">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <textarea id="cvresumeform-description" class="form-control" name="CvResumeForm[description]">Cập nhật ngày: 28/10/2024</textarea>
                                                                                ...
                                                                                <div class="form-group field-cvresumeform-file_upload">
                                                                                    ...
                                                                                    <div class="col-sm-4">
                                                                                        <input type="hidden" name="CvResumeForm[file_upload]" value="">
                                                                                        <div class="uploader bg-blue" id="uniform-cvresumeform-file_upload"><input type="file" id="cvresumeform-file_upload" class="file-styled" name="CvResumeForm[file_upload]"><span class="filename" style="user-select: none;">No file selected</span><span class="action" style="user-select: none;"><i class="icon-file-plus"></i></span></div>

                                                                                        <p class="help-block help-block-error "></p>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="hide">
                                                                                    <input type="hidden" name="CvResumeForm[jid]" value="">
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <div class="col-sm-offset-4 col-sm-4">
                                                                                        <button type="submit" class="btn btn-primary  btn-ladda btn-ladda-spinner btn-ladda-progress" data-style="zoom-out"><i class="icon-file-upload position-left"></i> <span class="ladda-label">Tải tài liệu lên</span><span class="ladda-spinner"></span><span class="ladda-spinner"></span></button> </div>
                                                                                </div>
                                    ...
                                    <div class="content-group">
                                        ...
                                        <div class="panel no-border-top no-border-radius-top">
                                            <ul class="navigation">
                                                ...
                                                <li><a href="candidate/import-linkedin-data"><i class="icon-linkedin"></i>Nhập thông tin từ LinkedIn</a>
                                                </li>
                                                <li data-intro='<h4 class="text-center">CV Go đã xuất hiện!</h4><p><strong>CV Go</strong> giúp bạn tạo CV cực chất trong chưa đầy 5 phút. Thử ngay!</p> <img width="200px" src="/cv_template/assets/images/theme/cv3.png" />'>
                                                    <a href="/candidate/pre-profile?tab=manage-resume" target="_blank"><i class="icon-copy"></i>CV Go - Tạo CV cực
                                                ...
                                                <li><a href="candidate/jobs-matching" title="Danh sách việc làm phù hợp"><i class="icon-stack4"></i>
