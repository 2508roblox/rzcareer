    ...
    <div>
       ...
       $(document).ready(function () {
           setTimeout(function () {
            ...
            <script>
                window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-EHD5KK9TRQ'); 
            </script>
        </head>
                                                        ...
                                                        <div class="carousel-inner">
                                                            <div class="item active">
                                                                <a href="/candidate/video-clip">
                                                                    <picture><img src="/media/home/4.png" width="100%"
                                                                            class="img-responsive" alt="JobsGO Banner">
                                                                    </picture>
                                                                </a>
                                                            </div>
