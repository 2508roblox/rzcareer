...
<div>
 ...
 <html lang="vi-VN">
 <head>
   <link rel="preload" href="/assets_livewire/teks/css/fonts/xn7gYHE41ni1AdIRggexSg.woff2" as="font" type="font/woff2" crossorigin> <link rel="preload" href="/assets_livewire/teks/css/fonts/xn7gYHE41ni1AdIRggixSuXd.woff2" as="font" type="font/woff2" crossorigin> <link rel="preload" href="/assets_livewire/teks/css/fonts/xn7gYHE41ni1AdIRggmxSuXd.woff2" as="font" type="font/woff2" crossorigin> <link rel="preload" href="/assets_livewire/teks/css/fonts/xn7gYHE41ni1AdIRggOxSuXd.woff2" as="font" type="font/woff2" crossorigin> <link rel="preload" href="/assets_livewire/teks/css/fonts/xn7gYHE41ni1AdIRggqxSuXd.woff2" as="font" type="font/woff2" crossorigin> <link rel="preload" href="/assets_livewire/teks/css/fonts/xn7gYHE41ni1AdIRggSxSuXd.woff2" as="font" type="font/woff2" crossorigin>
 ...
 <script type="text/javascript" src="/assets_livewire/bolt/assets/js/plugins/fancybox-master/dist/jquery.fancybox.min.js?colorgb=234208153092"></script>
 ...
 <script type="text/javascript" src="/assets_livewire/cv_template/dist/js/intro.js?v=234208153092"></script>
   ...
   <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-EHD5KK9TRQ'); </script>
 </head>
 ...
 <li><a data-caption="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng" target="_blank" href="/candidate/detail?v=1727321539" title="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng"><i class='bx bx-user-pin'></i> Xem / tải về hồ sơ</a></li>
 <li class="divider"></li>
 ...
 <li class="divider"></li>
 <li><a href="javascript: void(0)"> <div class="switcher"><input type="checkbox" id="switch__input" class="switch__input" checked> <label for="switch__input" id="switch__label" class="switch__label status_on">Đang tìm việc</label></div></a></li>
 <li class="divider"></li>
     ...
     window.addEventListener('load', function () {
         $(function () {
             ...
             $('#switch__input').on('change', function () {
                 $.ajax({
                     url: '/api/profile', data: {pk: 1, name: 'status', value: $(this).is(':checked') ? 0 : 2}, success: function (response) {
 ...
 <div class="page-container ">
   ...
   <div class="page-content">
     ...
     <div class="content-wrapper">
         ...
         <link href="/assets_livewire/v3/layout/style.css?v=234208153092" rel="stylesheet">
 <link href="/assets_livewire/v3/icofont/icofont.min.css" rel="stylesheet">
 ...
 <nav>
     <ol class="cd-breadcrumb triangle custom-icons no-margin-top">
         ...
         <li class="btn-default"><a href="candidate/pre-profile?tab=review">
                 <div class="nav-item"><i class="fa fa-exclamation-triangle"></i> Cập nhật hồ sơ <div style="position:absolute;top:-5px;right:0px;font-size:9px;color:white;background:#ff5722;border-radius: 9px;width: 16px;height: 16px;line-height: 16px;;text-align:center">67</div>                </div>
             </a></li>
     ...
     <div class="alert-candidate">
         <div class="alert alert-info"><i class="icon-file-upload2"></i> Tiết kiệm thời gian cập nhật hồ sơ bằng cách tải
             lên CV. <a href="/assets_livewire/phan-tich-cv.html" target="_blank"><u><b>Upload CV ngay!</b></u></a>
         </div>
     </div>
 <style>
     nav li {
 ...
 <script>
     ...
     function closeAlertUpdateCv() {
         ...
         $.cookie('alertNotificationUpdateCvHidden', 'true', { expires: expirationDate });
     }
             ...
             <div class="flex-contain">
                 <div class="flex-left ">
                     ...
                     <div class="hide">
                         ...
                         <div class="p15 hidden-xs">
                             <p class="text-uppercase fontz12 text-muted">Giới thiệu bản thân (Video CV)</p>
                                                                                     <a href="/candidate/video-clip" class="btn btn-primary"><i class="glyphicon glyphicon-facetime-video"></i>
                                 Thêm Video CV</a>
                         </div>
                     </div>
                     ...
                     <div class="p15 hidden-xs">
                         <p class="text-uppercase fontz12 text-muted">Hồ sơ xin việc</p>
                 ...
                 <span class="progress-left">
                     ...
                     <span class="progress-bar"></span>
                         ...
                         <p class="mt-20 mb-0"><a href="/candidate/pre-profile" class="btn btn-edit-profile"><i class="icofont-ui-edit"></i>
                                 Cập nhật hồ sơ</a></p>
                     </div>
 
                     <div class="line-divider hidden-xs"></div>
                     <div class="p15 hidden-xs">
                         <p class="text-uppercase fontz12 text-muted">Tệp đính kèm</p>
                                                                         <a href="/candidate/document-attachment" class="btn btn-default"><i class="fa fa-paperclip"></i>
                             Quản lý tệp đính kèm</a>
                     </div>
                 </div>
 
                 <div class="flex-center">
                     <div class="p15">
                         <div class="ntv-profile-flexcenter-sc1 clearfix mb-20">
                             <a href="/candidate/employers-viewed" class="media">
                                 <div class="media-left"><i class="bg-luot_xem"></i>
                                 </div>
                             ...
                             <a href="/chat/" data-caption="Tin nhắn từ nhà tuyển dụng" data-fancybox="" data-type="iframe" title="Tin nhắn từ nhà tuyển dụng" class="media">
                         ...
                         <div class="p-5">
                             ...
                             <div id="myCarousel" class="carousel hide slide mb-20" data-ride="carousel">
                                 <!-- Indicators -->
                                 ...
                                 <div class="carousel-inner">
                                     <div class="item active">
                                         <a href="/candidate/video-clip">
                                             <picture><img src="/media/home/4.png" width="100%" class="img-responsive" alt="JobsGO Banner"></picture>
                                         </a>
                                     </div>
                             ...
                             <p class="text-uppercase fontz12 text-muted text-left">
 ...
 <link rel="stylesheet" href="/assets_livewire/css/cropper.css">
 <link rel="stylesheet" href="/assets_livewire/css/crop.css?v=234208153092">
 ...
 <script>
     ...
     function f1(index) {
         ...
         $('.lds-ripple').show();
         $.ajax({
             url: "/api/candidate-job-suggest?index=" + index, success: function (result) {
     ...
     function f2(id) {
         $.ajax({
             url: "/api/set-job-love?id=" + id, success: function (result) {
                 var obj = JSON.parse(result);
                 ...
                 <div class="content-group">
                   <div class="panel-body bg-blue-800 text-center">
                     <div class="content-group-sm">
                       <a data-caption="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng" data-fancybox data-type="iframe" class="text-white" href="/assets_livewire/candidate/detail?v=1727321539" title="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng">
 ...
 <div class="modal" id="colorgbIframeModal" tabindex="-1">
   ...
   <script>
       ...
       function message() {
           $.ajax({
               url: "/message/new", success: function (result) {
                   var obj = JSON.parse(result);
                   var nm = $(".new-message");
                   var lm = $(".list-message");
                   if (obj.cn > 0) {
 ...
 <script>
     ...
     $(function () {
             ...
             $.ajax({
                 url: "/api/logged?utm_source=&utm_medium=", success: function (result) {
     ...
     <div class="modal-dialog">
       ...
       <div class="modal-content">
         ...
         <div class="modal-body pt-5">
           ...
           <p>Vui lòng xem nội dung Quy chế hoạt động sau khi cập nhật <a target="_blank" href="/assets_livewire/pdf/viewer/?file=/media/pdf/quy-che-hoat-dong.pdf">tại đây</a></p>
           ...
           <div class="checkbox">
             <label><input id="save_cv" checked type="checkbox"> <span class="text-default">Tôi đồng ý để JobsGO.vn xử lý các dữ liệu cá nhân của mình theo quy định tại <a target="_blank" href="/assets_livewire/pdf/viewer/?file=/media/pdf/quy-che-hoat-dong.pdf">Quy chế hoạt động</a> và <a target="_blank" href="/assets_livewire/pdf/viewer/?file=/media/pdf/chinh-sach.pdf">Chính sách xử lý dữ liệu cá nhân</a></span> </label>
           </div>
