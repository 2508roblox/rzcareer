<div>
    <div>
        ...
        <head>
            ...
            <meta name="csrf-token" content="dMyWkIl86nFBAdpOQ46lc6E-qeMZWVYWM8uNM4S86ONH-eHV6CSiKzh4tgg579wK7W_Eol5gAFpZ-bpq842yuw==">
                        ...
                        <ul class="nav navbar-nav navbar-right" style="float:right !important;">
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a data-caption="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng" target="_blank" href="/candidate/detail?v=1727351239" title="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng"><i class='bx bx-user-pin'></i> Xem / tải về hồ sơ</a></li>
                                    <li class="divider"></li>
                                ...
                                <div class="tab-pane fade in active" id="profile">
                                    ...
                                    <div class="panel panel-flat">
                                        ...
                                        <div class="panel-body">
                                            <form id="w0" class="form-horizontal" action="/candidate/change-password" method="post">
                                                <input type="hidden" name="_csrf-jobsgo-candidate" value="dMyWkIl86nFBAdpOQ46lc6E-qeMZWVYWM8uNM4S86ONH-eHV6CSiKzh4tgg579wK7W_Eol5gAFpZ-bpq842yuw==">




                                                <div class="form-group field-changepasswordform-new_password required">
                                                    <label class="control-label col-sm-4 text-right" for="changepasswordform-new_password">Mật khẩu mới</label>
                                                    <div class="col-sm-4">
                                                        <input type="password" id="changepasswordform-new_password" class="form-control" name="ChangePasswordForm[new_password]" placeholder="Nhập mật khẩu mới" aria-required="true">

                                                        <p class="help-block help-block-error "></p>
                                                    </div>
                                                </div>
                                                <div class="form-group field-changepasswordform-confirm_password required">
                                                    <label class="control-label col-sm-4 text-right" for="changepasswordform-confirm_password">Xác nhận mật khẩu</label>
                                                    <div class="col-sm-4">
                                                        <input type="password" id="changepasswordform-confirm_password" class="form-control" name="ChangePasswordForm[confirm_password]" placeholder="Nhập lại mật khẩu mới" aria-required="true">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-4 col-sm-5">
                                                        <button type="submit" class="btn btn-primary  btn-ladda btn-ladda-spinner btn-ladda-progress" data-style="zoom-out"><i class="icon-floppy-disk position-left"></i> <span class="ladda-label">Lưu lại</span></button>
                                                    </div>
                                                </div>
                                ...
                                <div class="content-group">
                                    <div class="panel-body bg-blue-800 text-center">
                                        <div class="content-group-sm">
                                            <a data-caption="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng" data-fancybox data-type="iframe" class="text-white" href="https://jobsgo.vn/candidate/detail?v=1727351239" title="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng">
    ...
    <script src="/event/min.js?v=1727351239"></script>
    ...
    <script>
        jQuery(function($) {
            jQuery('#w0').yiiActiveForm([{
                "id": "changepasswordform-new_password",
                "name": "new_password",
                "container": ".field-changepasswordform-new_password",
                "input": "#changepasswordform-new_password",
                ...
                "validate": function(attribute, value, messages, deferred, $form) {
                    ...
                    yii.validation.string(value, messages, {
                        ...
                        "min": 6,
                        "tooShort": "Mật khẩu mới phải chứa ít nhất 6 ký tự.",
                        "skipOnEmpty": 1
                    });
                }
            }, {
                "id": "changepasswordform-confirm_password",
                "name": "confirm_password",
                "container": ".field-changepasswordform-confirm_password",
                "input": "#changepasswordform-confirm_password",
                "error": ".help-block.help-block-error",
                "validate": function(attribute, value, messages, deferred, $form) {
                    yii.validation.required(value, messages, {
                    ...
                    yii.validation.string(value, messages, {
                        ...
                        "min": 6,
                        "tooShort": "Xác nhận mật khẩu phải chứa ít nhất 6 ký tự.",
                        "skipOnEmpty": 1
                    });
                    yii.validation.compare(value, messages, {
                        "operator": "==",
                        "type": "string",
                        "compareAttribute": "changepasswordform-new_password",
                        "compareAttributeName": "ChangePasswordForm[new_password]",
                        "skipOnEmpty": 1,
    ...
    </script><a data-caption="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng" data-fancybox data-type="iframe" href="https://jobsgo.vn/candidate/detail?v=1727351239" title="Hồ sơ xin việc của bạn trong mắt nhà tuyển dụng" class="btn-colorgb-float"> <i class="icon-vcard icon-float"></i> <span>Xem / tải về hồ sơ</span> </a>
