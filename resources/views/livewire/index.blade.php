                        ...
                        <div class="row g-0 align-items-center">
                          <div class="col-4 p-1 text-center">
                            <img height="90" width="90" loading="lazy"
                              src="/assets_livewire/img/2024/ic1.svg?v=234208153092" alt="Đánh giá CV - Rzcareer">
                          </div>
                          <div class="col-8">
                            <div class="card-body">
                              <h3 class="fs-6 card-title fw-bold">Đánh giá CV - Rzcareer</h3>
                ...
                <h6>
                  ...
                  <div class="row my-3 mt-4 text-center">
                    ...
                    <div class="col-6">
                      ...
                      <p>Số lượng Apply</p>
                      @php
                        $applyRate = App\Models\PostActivity::count();
                        @endphp
                        <strong>{{ $applyRate }}</strong>
                    </div>
                  </div>
                </h6>
              </div>
                      ...
                      <div class="card border-primary w-100">
                        <div class="row g-0 align-items-center">
                          ...
                          <div class="col-8">
                            <div class="card-body">
                              <h3 class="fs-6 card-title fw-bold">Tạo CV tự động trong 2 phút</h3>
                              <p class="card-text small">Tạo CV xin việc Online chuẩn, đẹp miễn phí với Rzcareer template</p>
          ...
          <div class="teks-section py-4 py-sm-5">
            <div class="row align-items-center row-cols-lg-3">
              <div class="col-lg-3 teks-section-title ps-3 text-center text-lg-start">
                <h2 class="text-dark fs-5">Tra cứu lương <small class="badge bg-danger p-1 font-size-sm">Mới</small>
                </h2>
                <p class="w-100 mb-3 text-dark">Tiện ích tra cứu & tìm hiểu mức lương <br> theo ngành nghề và vị trí công việc
                  2024</p>
